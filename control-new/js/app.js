...
import { confirmModal, alertModal } from "../../js/core/modal.js?v=v2026-06-03T21150";
import { getUiLang, initI18n, t } from "../../translation/translation.js?v=v2026-06-03T21150";
import { v as cacheBust } from "../../js/core/cache-bust.js?v=v2026-06-03T21150";
...
import { requireAuth, signOut } from "../../js/core/auth.js?v=v2026-06-03T21150";
import { setTopbarAccount } from "../../js/core/topbar-controller.js?v=v2026-06-03T21150";
import { isGuestUser } from "../../js/core/guest-mode.js?v=v2026-06-03T21150";
import { sb } from "../../js/core/supabase.js?v=v2026-06-03T21150";
import { rt } from "../../js/core/realtime.js?v=v2026-06-03T21150";
import { validateGameReadyToPlay, loadGameBasic, loadQuestions, loadAnswers } from "../../js/core/game-validate.js?v=v2026-06-03T21150";
import { unlockAudio, isAudioUnlocked, playSfx } from "../../js/core/sfx.js?v=v2026-06-03T21150";
import {
  ...
  initSfx,
} from "../../js/core/sfx-new.js?v=v2026-06-03T21150";
import {
  getSfxSaveFlag, setSfxSaveFlag,
  uploadSoundToCloud, deleteSoundFromCloud, deleteAllSoundsFromCloud, listCloudSounds,
} from "../../js/core/sfx-cloud.js?v=v2026-06-03T21150";
import { createStore } from "./store.js?v=v2026-06-03T21150";
import { createUI } from "./ui.js?v=v2026-06-03T21150";
import { createDevices } from "./devices.js?v=v2026-06-03T21150";
import { createPresence } from "./presence.js?v=v2026-06-03T21150";
import { createDisplay } from "./display.js?v=v2026-06-03T21150";
import { createRounds } from "./gameRounds.js?v=v2026-06-03T21150";
import { createFinal } from "./gameFinal.js?v=v2026-06-03T21150";
import { initShareDevice } from "./share-device.js?v=v2026-06-03T21150";
import { loadFont5x7, buildLogoPreviewCanvas } from "../../js/core/logo-preview.js?v=v2026-06-03T21150";
