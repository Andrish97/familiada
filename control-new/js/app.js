...
import { confirmModal, alertModal } from "../../js/core/modal.js?v=v2026-06-13T07282";
import { getUiLang, initI18n, t } from "../../translation/translation.js?v=v2026-06-13T07282";
import { v as cacheBust } from "../../js/core/cache-bust.js?v=v2026-06-13T07282";
...
import { requireAuth, signOut } from "../../js/core/auth.js?v=v2026-06-13T07282";
import { setTopbarAccount } from "../../js/core/topbar-controller.js?v=v2026-06-13T07282";
import { isGuestUser } from "../../js/core/guest-mode.js?v=v2026-06-13T07282";
import { sb } from "../../js/core/supabase.js?v=v2026-06-13T07282";
import { rt } from "../../js/core/realtime.js?v=v2026-06-13T07282";
import { validateGameReadyToPlay, loadGameBasic, loadQuestions, loadAnswers } from "../../js/core/game-validate.js?v=v2026-06-13T07282";
import { unlockAudio, isAudioUnlocked, playSfx } from "../../js/core/sfx.js?v=v2026-06-13T07282";
import {
  ...
  initSfx,
} from "../../js/core/sfx-new.js?v=v2026-06-13T07282";
import {
...
import { createDisplay } from "./display.js?v=v2026-06-13T07282";
import { createRounds } from "./gameRounds.js?v=v2026-06-13T07282";
import { createFinal } from "./gameFinal.js?v=v2026-06-13T07282";
import { initShareDevice } from "./share-device.js?v=v2026-06-13T07282";
import { loadFont5x7, buildLogoPreviewCanvas } from "../../js/core/logo-preview.js?v=v2026-06-13T07282";
  ...
  function renderSetupFinishSummary() {
    ...
    if (soundEl) {
      ...
      for (const cat of cats) {
        ...
        const isNonDefault = variant && variant !== "classic.mp3?v=v2026-06-13T07282";
        const parts = [];
