...
import { confirmModal } from "../../js/core/modal.js?v=v2026-07-10T22471";
import { getUiLang, initI18n, t } from "../../translation/translation.js?v=v2026-07-10T22471";
import { v as cacheBust } from "../../js/core/cache-bust.js?v=v2026-07-10T22471";
...
import { requireAuth, signOut } from "../../js/core/auth.js?v=v2026-07-10T22471";
import { setTopbarAccount } from "../../js/core/topbar-controller.js?v=v2026-07-10T22471";
import { isGuestUser } from "../../js/core/guest-mode.js?v=v2026-07-10T22471";
import { sb } from "../../js/core/supabase.js?v=v2026-07-10T22471";
import { rt } from "../../js/core/realtime.js?v=v2026-07-10T22471";
import { validateGameReadyToPlay, loadGameBasic, loadQuestions, loadAnswers } from "../../js/core/game-validate.js?v=v2026-07-10T22471";
import { unlockAudio, isAudioUnlocked, playSfx } from "../../js/core/sfx.js?v=v2026-07-10T22471";
import { createStore } from "./store.js?v=v2026-07-10T22471";
import { createUI } from "./ui.js?v=v2026-07-10T22471";
import { createDevices } from "./devices.js?v=v2026-07-10T22471";
import { createPresence } from "./presence.js?v=v2026-07-10T22471";
import { createDisplay } from "./display.js?v=v2026-07-10T22471";
import { createRounds } from "./gameRounds.js?v=v2026-07-10T22471";
import { createFinal } from "./gameFinal.js?v=v2026-07-10T22471";
import { initShareDevice } from "./share-device.js?v=v2026-07-10T22471";
import { loadFont5x7, buildLogoPreviewCanvas } from "../../js/core/logo-preview.js?v=v2026-07-10T22471";
