...
import { confirmModal } from "../../js/core/modal.js?v=v2026-07-13T12295";
import { getUiLang, initI18n, t } from "../../translation/translation.js?v=v2026-07-13T12295";
import { v as cacheBust } from "../../js/core/cache-bust.js?v=v2026-07-13T12295";
...
import { requireAuth, signOut } from "../../js/core/auth.js?v=v2026-07-13T12295";
import { setTopbarAccount } from "../../js/core/topbar-controller.js?v=v2026-07-13T12295";
import { isGuestUser } from "../../js/core/guest-mode.js?v=v2026-07-13T12295";
import { sb } from "../../js/core/supabase.js?v=v2026-07-13T12295";
import { rt } from "../../js/core/realtime.js?v=v2026-07-13T12295";
import { validateGameReadyToPlay, loadGameBasic, loadQuestions, loadAnswers } from "../../js/core/game-validate.js?v=v2026-07-13T12295";
import { unlockAudio, isAudioUnlocked, playSfx, stopSfx, isSfxPlaying, onSfxEnd, initSfx, loadSfxManifest, applySfxGameSettings, setCurrentGameId, loadSfxFromCloud, getSfxCategories, getSfxVariant, getSfxVolume, setSessionSfxVolume, getSfxCustomFiles } from "../../js/core/sfx-new.js?v=v2026-07-13T12295";
import { listGameSounds } from "../../js/core/sfx-cloud.js?v=v2026-07-13T12295";
import { createStore } from "./store.js?v=v2026-07-13T12295";
import { createUI } from "./ui.js?v=v2026-07-13T12295";
import { createDevices } from "./devices.js?v=v2026-07-13T12295";
import { createPresence } from "./presence.js?v=v2026-07-13T12295";
import { createDisplay } from "./display.js?v=v2026-07-13T12295";
import { createRounds } from "./gameRounds.js?v=v2026-07-13T12295";
import { createFinal } from "./gameFinal.js?v=v2026-07-13T12295";
import { initShareDevice } from "./share-device.js?v=v2026-07-13T12295";
import { loadFont5x7, buildLogoPreviewCanvas } from "../../js/core/logo-preview.js?v=v2026-07-13T12295";
