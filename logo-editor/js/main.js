...
import { addRenameGesture } from "../../js/core/rename-gesture.js?v=v2026-07-13T11521";
...
import { requireAuth } from "../../js/core/auth.js?v=v2026-07-13T11521";
import { isGuestUser } from "../../js/core/guest-mode.js?v=v2026-07-13T11521";
import { alertModal, confirmModal } from "../../js/core/modal.js?v=v2026-07-13T11521";
import { getUiLang, initI18n, t, withLangParam } from "../../translation/translation.js?v=v2026-07-13T11521";
import { initTopbarAccountDropdown } from "../../js/core/topbar-controller.js?v=v2026-07-13T11521";
import { isMobileDevice } from "../../js/core/pwa.js?v=v2026-07-13T11521";
import { v as cacheBust } from "../../js/core/cache-bust.js?v=v2026-07-13T11521";

import { initTextEditor } from "./text.js?v=v2026-07-13T11521";
import { initDrawEditor } from "./draw.js?v=v2026-07-13T11521";
import { initImageEditor } from "./image.js?v=v2026-07-13T11521";
...
const FONT_3x10_URL = "display/font_3x10.json?v=v2026-07-13T11521";
const FONT_5x7_URL  = "display/font_5x7.json?v=v2026-07-13T11521";
const DEFAULT_LOGO_URL = "display/logo_familiada.json?v=v2026-07-13T11521";
...
async function boot(){
  ...
  import('../../js/core/updater.js?v=v2026-07-13T11521').then(m => m.initUpdater()).catch(() => {});
