...
import { addRenameGesture } from "../../js/core/rename-gesture.js?v=v2026-08-18T18235";
import { loadFont5x7, buildLogoPreviewCanvas } from "../../js/core/logo-preview.js?v=v2026-08-18T18235";

import { sb } from "../../js/core/supabase.js?v=v2026-08-18T18235";
import { requireAuth } from "../../js/core/auth.js?v=v2026-08-18T18235";
import { isGuestUser } from "../../js/core/guest-mode.js?v=v2026-08-18T18235";
import { alertModal, confirmModal } from "../../js/core/modal.js?v=v2026-08-18T18235";
import { getUiLang, initI18n, t, withLangParam } from "../../translation/translation.js?v=v2026-08-18T18235";
import { initTopbarAccountDropdown } from "../../js/core/topbar-controller.js?v=v2026-08-18T18235";
import { isMobileDevice } from "../../js/core/pwa.js?v=v2026-08-18T18235";
import { v as cacheBust } from "../../js/core/cache-bust.js?v=v2026-08-18T18235";

import { initTextEditor } from "./text.js?v=v2026-08-18T18235";
import { initDrawEditor } from "./draw.js?v=v2026-08-18T18235";
import { initImageEditor } from "./image.js?v=v2026-08-18T18235";
...
const FONT_3x10_URL = "display/font_3x10.json?v=v2026-08-18T18235";
const FONT_5x7_URL  = "display/font_5x7.json?v=v2026-08-18T18235";
const DEFAULT_LOGO_URL = "display/logo_familiada.json?v=v2026-08-18T18235";
...
async function boot(){
  ...
  import('../../js/core/updater.js?v=v2026-08-18T18235').then(m => m.initUpdater()).catch(() => {});
