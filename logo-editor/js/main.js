...
import { addRenameGesture } from "../../js/core/rename-gesture.js?v=v2026-04-13T22050";
import { loadFont5x7, buildLogoPreviewCanvas } from "../../js/core/logo-preview.js?v=v2026-04-13T22050";

import { sb } from "../../js/core/supabase.js?v=v2026-04-13T22050";
import { requireAuth } from "../../js/core/auth.js?v=v2026-04-13T22050";
import { isGuestUser } from "../../js/core/guest-mode.js?v=v2026-04-13T22050";
import { alertModal, confirmModal } from "../../js/core/modal.js?v=v2026-04-13T22050";
import { getUiLang, initI18n, t, withLangParam } from "../../translation/translation.js?v=v2026-04-13T22050";
import { initTopbarAccountDropdown } from "../../js/core/topbar-controller.js?v=v2026-04-13T22050";
import { isMobileDevice } from "../../js/core/pwa.js?v=v2026-04-13T22050";
import { v as cacheBust } from "../../js/core/cache-bust.js?v=v2026-04-13T22050";

import { initTextEditor } from "./text.js?v=v2026-04-13T22050";
import { initDrawEditor } from "./draw.js?v=v2026-04-13T22050";
import { initImageEditor } from "./image.js?v=v2026-04-13T22050";
...
async function boot(){
  ...
  import('../../js/core/updater.js?v=v2026-04-13T22050').then(m => m.initUpdater()).catch(() => {});
