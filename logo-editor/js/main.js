...
import { addRenameGesture } from "../../js/core/rename-gesture.js?v=v2026-04-07T13501";
import { loadFont5x7, buildLogoPreviewCanvas } from "../../js/core/logo-preview.js?v=v2026-04-07T13501";

import { sb } from "../../js/core/supabase.js?v=v2026-04-07T13501";
import { requireAuth } from "../../js/core/auth.js?v=v2026-04-07T13501";
import { isGuestUser } from "../../js/core/guest-mode.js?v=v2026-04-07T13501";
import { alertModal, confirmModal } from "../../js/core/modal.js?v=v2026-04-07T13501";
import { getUiLang, initI18n, t, withLangParam } from "../../translation/translation.js?v=v2026-04-07T13501";
import { initTopbarAccountDropdown } from "../../js/core/topbar-controller.js?v=v2026-04-07T13501";
import { isMobileDevice } from "../../js/core/pwa.js?v=v2026-04-07T13501";
import { v as cacheBust } from "../../js/core/cache-bust.js?v=v2026-04-07T13501";

import { initTextEditor } from "./text.js?v=v2026-04-07T13501";
import { initDrawEditor } from "./draw.js?v=v2026-04-07T13501";
import { initImageEditor } from "./image.js?v=v2026-04-07T13501";
...
async function boot(){
  ...
  import('../../js/core/updater.js?v=v2026-04-07T13501').then(m => m.initUpdater()).catch(() => {});
