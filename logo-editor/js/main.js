...
import { addRenameGesture } from "../../js/core/rename-gesture.js?v=v2026-04-08T03142";
import { loadFont5x7, buildLogoPreviewCanvas } from "../../js/core/logo-preview.js?v=v2026-04-08T03142";

import { sb } from "../../js/core/supabase.js?v=v2026-04-08T03142";
import { requireAuth } from "../../js/core/auth.js?v=v2026-04-08T03142";
import { isGuestUser } from "../../js/core/guest-mode.js?v=v2026-04-08T03142";
import { alertModal, confirmModal } from "../../js/core/modal.js?v=v2026-04-08T03142";
import { getUiLang, initI18n, t, withLangParam } from "../../translation/translation.js?v=v2026-04-08T03142";
import { initTopbarAccountDropdown } from "../../js/core/topbar-controller.js?v=v2026-04-08T03142";
import { isMobileDevice } from "../../js/core/pwa.js?v=v2026-04-08T03142";
import { v as cacheBust } from "../../js/core/cache-bust.js?v=v2026-04-08T03142";

import { initTextEditor } from "./text.js?v=v2026-04-08T03142";
import { initDrawEditor } from "./draw.js?v=v2026-04-08T03142";
import { initImageEditor } from "./image.js?v=v2026-04-08T03142";
...
async function boot(){
  ...
  import('../../js/core/updater.js?v=v2026-04-08T03142').then(m => m.initUpdater()).catch(() => {});
