...
import { addRenameGesture } from "../../js/core/rename-gesture.js?v=v2026-04-05T03504";
import { loadFont5x7, buildLogoPreviewCanvas } from "../../js/core/logo-preview.js?v=v2026-04-05T03504";

import { sb } from "../../js/core/supabase.js?v=v2026-04-05T03504";
import { requireAuth } from "../../js/core/auth.js?v=v2026-04-05T03504";
import { isGuestUser } from "../../js/core/guest-mode.js?v=v2026-04-05T03504";
import { alertModal, confirmModal } from "../../js/core/modal.js?v=v2026-04-05T03504";
import { getUiLang, initI18n, t, withLangParam } from "../../translation/translation.js?v=v2026-04-05T03504";
import { initTopbarAccountDropdown } from "../../js/core/topbar-controller.js?v=v2026-04-05T03504";
import { isMobileDevice } from "../../js/core/pwa.js?v=v2026-04-05T03504";
import { v as cacheBust } from "../../js/core/cache-bust.js?v=v2026-04-05T03504";

import { initTextEditor } from "./text.js?v=v2026-04-05T03504";
import { initDrawEditor } from "./draw.js?v=v2026-04-05T03504";
import { initImageEditor } from "./image.js?v=v2026-04-05T03504";
...
async function boot(){
  ...
  import('../../js/core/updater.js?v=v2026-04-05T03504').then(m => m.initUpdater()).catch(() => {});
