...
import { confirmModal } from "../../js/core/modal.js?v=v2026-04-04T17104";
import { initUiSelect } from "../../js/core/ui-select.js?v=v2026-04-04T17104";
import { t } from "../../translation/translation.js?v=v2026-04-04T17104";
  ...
  function renderToolSettings() {
    ...
    if (tn === "brush") {
      ...
      showSettings(`
        ...
        <div class="ctxGroup"><button class="ctxBtn" id="cAL" ${textAlign==="center"?"on":textAlign==="right"?"on":""}>${alignIcon(textAlign)}</button></div>
        <div class="ctxGroup"><span class="ctxLabel">Kolor</span>${ctxColorBtn(fg)}</div>
      `);
