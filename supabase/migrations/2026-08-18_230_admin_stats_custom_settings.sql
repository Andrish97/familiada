-- Nowa sekcja panelu admina: gry, których zaawansowane ustawienia
-- (mnożniki rund, próg/cel finału, tryb ekranu końcowego, nagroda)
-- różnią się od wartości domyślnych z control/js/store.js.
--
-- Dane już istniały (games.settings jsonb) — to tylko nowe odczyty,
-- nic w games/game_sessions/innych sekcjach nie jest ruszane.
