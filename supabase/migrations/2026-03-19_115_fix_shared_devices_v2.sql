-- 115_fix: Naprawa shared_devices_v2 – DROP funkcji przed zmianą sygnatury

-- Kolumny już zostały dodane przez częściowe wykonanie 115, więc tylko DROP+CREATE funkcji
...
-- share_device z nowymi parametrami
