-- 089: Fix demo questions and user games - "Sondaż:" → "Ankieta:"
-- SUPERSEDES: 2026-04-02_087_update_demo_questions.sql
-- This migration corrects the table names used in 087 (demo_template_data instead of demo_bases/demo_games)
