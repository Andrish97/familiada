-- Migration: 2026-04-05_101_final_fix_restore_demo.sql
-- Purpose: Final fix for demo restoration with correct field mapping and checksum resolution.
-- Mapping: user_logos.name = template.payload->'name', 
--          user_logos.type = mapped kind, 
--          user_logos.payload = template.payload->'payload'
...
-- 1. Redefine seed_demo_for_user with exact mapping
