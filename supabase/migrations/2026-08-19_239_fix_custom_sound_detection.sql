-- "Niestandardowy dźwięk" liczyło grę jako spersonalizowaną, gdy
-- settings.sound miało JAKIEKOLWIEK klucze — a to dzieje się już przy
-- samej zmianie głośności suwakiem, bez żadnego wgranego pliku. Poprawna
-- definicja "niestandardowego dźwięku" to realnie przesłany własny plik:
-- sound.variants[jakikolwiek klucz] === '__custom__'. Poprawka w obu
-- miejscach, które to liczą.
