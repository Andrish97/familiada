-- 069: Fix is_read column - force add if missing

-- Force add is_read column (drop and recreate if exists)
DO $$ 
BEGIN 
  IF NOT EXISTS (
...
-- Force recreate mark_message_read function
