-- SUPERSEDES: 2026-06-15_208_drop_is_active_user_logos.sql
-- 213: Przywróć case 'games' i 'gameplay' w get_stats_detail — migration 208 je usunęła przez nieuwagę.
-- Gameplay używa device_presence (game_sessions nie istnieje).
-- Logos bez is_active (usunięte w migration 208) — zachowujemy poprawną wersję.
