-- SUPERSEDES: 2026-03-30_170_stats_detail_rpc.sql
-- Migration: Fix get_admin_stats and get_stats_detail
--   - is_demo=false filter for question_bases and user_logos
--   - source_market_id IS NULL for all game queries
--   - excluded_ids applied consistently across get_stats_detail
