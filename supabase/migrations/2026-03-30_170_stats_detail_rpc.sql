-- Migration: Extend get_admin_stats with today/30d time windows for games/bases/logos/ratings
-- + Add get_stats_detail(p_type, p_limit) RPC for tile modals

-- ============================================================
-- 1. Update get_admin_stats
-- ============================================================
...
GRANT EXECUTE ON FUNCTION public.get_stats_detail(text, int) TO service_role;
