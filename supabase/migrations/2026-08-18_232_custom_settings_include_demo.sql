-- "Niedomyślne ustawienia" ukrywało gry demo (is_demo = false), więc nie
-- dało się sprawdzić w panelu, czy ustawienia demo (np. wynik 400:500 na
-- grze "DEMO — Preparowana") faktycznie zostały zmienione. Ten sam
-- wyjątek co już jest w statystykach rozgrywek: rozegranie/zmiana
-- ustawień to działanie użytkownika, nawet na grze demo.
