const pl = {
  ...
  guestGuard: {
    ...
    about: {
      ...
      p3: "Do prowadzenia gry wystarczą urządzenia które już masz — rzutnik lub telewizor jako tablica wyników, tablet dla prowadzącego, telefon jako buzzer do pojedynku. Możesz także skorzystać z <a href=\"marketplace\" style=\"color:var(--gold);text-decoration:underline;\">gotowych pytań do Familiady</a> stworzonych przez naszą społeczność.",
    },
    tiles: {
