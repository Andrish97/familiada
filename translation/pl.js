const pl = {
  ...
  settings: {
    ...
    mail: {
      ...
      workerLimit: "Limit workera (domyślny)",
      cronSchedule: "Cron schedule",
      cronActive: "Cron aktywny",
      save: "Zapisz ustawienia maili",
      currentCron: "Cron",
      workerActions: "Ręczne akcje workera",
      runLimit: "Limit dla uruchomienia ręcznego",
      runWorker: "Uruchom worker",
      retryFailed: "Requeue failed + uruchom",
      retrySelected: "Requeue zaznaczone + uruchom",
      workerHint: "Opcje ręczne działają na `mail_queue` i uruchamiają `invoke_mail_worker(...)`.",
