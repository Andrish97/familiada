const pl = {
  ...
  common: {
    ...
    modal: {
      ...
      promptCancel: "Anuluj",
      closeLabel: "Zamknij",
      syncPreparing: "Przygotowuję…",
      syncProgress: "Synchronizuję… {synced} / {total}",
      syncNoErrors: "Brak błędów.",
    },
  ...
  control: {
    ...
    colorHint: "Zmiany wysyłamy na bieżąco.",
    ...
    audioUnlockHint: "Kliknij przycisk, żeby przeglądarka zezwoliła na dźwięk.",
    ...
    roundMultipliersHint: "Np. 1,1,1,2,3",
    gameTarget: "Cel rozgrywki",
    finalTarget: "Cel finału",
    gameEndMode: "Zakończenie gry",
    showLogo: "Pokaż logo",
    showPoints: "Pokaż punkty",
    showMoney: "Pokaż kwotę",
    advancedReset: "Domyślne",
    stepFinalPick: "Wybierz pytania finału",
    finalQuestions: "Pytania",
    finalBadge: "Finał:",
    finalPoolHint: "Pula pytań.",
    finalListHint: "Pytania finału (5).",
    finalOnlyHint: "Zatwierdzone.",
    refresh: "Odśwież",
    confirm: "Zatwierdź",
    edit: "Edytuj",
    stepRoundsPick: "Kolejność rund",
    roundsPickHint: "Ustaw kolejność pytań dla rund.",
    ...
    panelRounds: "Rundy",
    roundsReadyTitle: "Gotowe",
    roundsReadyName: "Przygotowanie",
    roundsReadyHint: "Upewnij się, że urządzenia są podłączone.",
    roundsReadyBtn: "Gra gotowa",
    roundsIntroTitle: "Intro",
    roundsIntroName: "Rozpocznij grę",
    roundsIntroHint: "Otwórz intro na wyświetlaczu.",
    roundsIntroBtn: "Rozpocznij grę",
    roundsStartTitle: "Start rundy",
    roundsStartName: "Pusta plansza",
    roundsStartHint: "Rozpocznij nową rundę.",
    roundsStartBtn: "Rozpocznij",
    roundsDuelTitle: "Przycisk",
    roundsDuelName: "Pojedynek",
    roundsDuelHint: "Zatwierdź lub powtórz naciśnięcie.",
    roundsBuzzAcceptA: "Zatwierdź A",
    roundsBuzzAcceptB: "Zatwierdź B",
    roundsBuzzRetry: "Ponów",
    roundsPlayTitle: "Runda",
    roundsPlayName: "Rozgrywka",
    roundsPlayHint: "Wciskaj odpowiedzi lub X.",
    roundsPassQuestion: "Oddaj pytanie",
    roundsAnswers: "Odpowiedzi",
    roundsAddX: "X (pudło)",
    roundsStartTimer3: "3s",
    roundsEndRound: "Zakończ rundę",
    roundsGameEndTitle: "Koniec",
    roundsGameEndName: "Zakończ grę",
    roundsGameEndHint: "Pokaż ekran końcowy.",
    roundsGameEndBtn: "Zakończ grę",
    panelFinal: "Finał",
    finalStartTitle: "Finał",
    finalStartName: "Rozpocznij",
    finalStartHint: "Wjazd planszy finału.",
    finalStartBtn: "Start",
    finalP1EntryTitle: "Gracz 1",
    finalP1EntryName: "Wpisywanie (15s)",
    finalP1EntryHint: "Wpisz odpowiedzi gracza.",
    finalStartTimer15: "Start (15s)",
    finalP1MapQ1Title: "Mapowanie 1",
    finalMapHint: "Wybierz odpowiedź z listy.",
    finalP1MapQ2Title: "Mapowanie 2",
    finalP1MapQ3Title: "Mapowanie 3",
    finalP1MapQ4Title: "Mapowanie 4",
    finalP1MapQ5Title: "Mapowanie 5",
    finalP2StartTitle: "Gracz 2",
    finalP2StartName: "Start 2 gracza",
    finalP2StartHint: "Dźwięk rundy, ukrycie P1.",
    finalP2StartBtn: "Start",
    finalRepeatSound: "Dźwięk powtórzenia",
    finalP2EntryTitle: "Gracz 2",
    finalP2EntryName: "Wpisywanie (20s)",
    finalP2EntryHint: "Wpisz odpowiedzi gracza.",
    finalStartTimer20: "Start (20s)",
    finalP2MapQ1Title: "Mapowanie 1",
    finalP2MapQ2Title: "Mapowanie 2",
    finalP2MapQ3Title: "Mapowanie 3",
    finalP2MapQ4Title: "Mapowanie 4",
    finalP2MapQ5Title: "Mapowanie 5",
    finalEndTitle: "Koniec",
    finalEndName: "Koniec finału",
    finalEndHint: "Zakończ finał i pokaż wynik.",
  ...
  settings: {
    ...
    validation: {
      tooSoonTitle: "Za wcześnie",
      tooSoonText: "Minimalny czas to 10 minut od teraz.",
      ok: "OK",
    },
    footerLeft: "Familiada — panel admina",
    footerRight: "Dostęp tylko dla uprawnionych.",
    login: {
      title: "Pulpit admina",
      checking: "Trwa weryfikacja…",
      accessRequired: "Wymagane logowanie przez Cloudflare Access.",
      loginBtn: "Zaloguj przez Access",
      hint: "Ten panel wymaga autoryzacji Cloudflare Access.",
    },
    maintenance: {
      title: "Prace techniczne",
      subtitle: "Ustawienia strony maintenance",
      enabled: "Maintenance",
      enabledHelp: "Włącz",
      mode: "Tryb",
      modeOff: "off",
      ...
      returnAt: "Powrót",
      returnAtHint: "Minimum 10 minut od teraz.",
      clearReturnAt: "Wyczyść returnAt",
      returnAtWarn: "Brak returnAt dla wybranego trybu.",
    ...
    debug: {
      title: "Debug / status",
      subtitle: "Aktualny stan i diagnostyka",
      lastRefresh: "Ostatnie odświeżenie",
      host: "Host",
      version: "Wersja",
      raw: "Surowy JSON",
      fetchError: "Nie udało się pobrać stanu.",
      saveError: "Nie udało się zapisać stanu.",
    },
    toast: {
      saved: "Zapisano",
      bypassOn: "Bypass włączony",
      bypassOff: "Bypass wyłączony",
      error: "Błąd operacji",
    },
    placeholder: {
      title: "Więcej ustawień",
      subtitle: "Miejsce na kolejne moduły",
      text: "Tutaj w przyszłości pojawią się dodatkowe ustawienia.",
    },
    bypass: {
      title: "Bypass",
    ...
    tools: {
      title: "Narzędzia",
      subtitle: "Skróty do narzędzi",
      placeholder: "Wybierz narzędzie",
      editor5x7: "Edytor 5x7",
    ...
    mail: {
      title: "Maile",
      subtitle: "Kolejka, logi i konfiguracja workera",
      settingsTitle: "Ustawienia wysyłki",
      queueEnabled: "Kolejkuj wysyłkę (send-mail -> mail_queue)",
      providerOrder: "Kolejność providerów",
      delayMs: "Zwłoka między wysyłkami (ms)",
      batchMax: "Maksymalna partia",
      workerLimit: "Ile maili na jedno uruchomienie workera",
      workerLimitHint: "To limit na jedno odpalenie (cron lub ręczne).",
      cronEvery: "Co jaki czas uruchamiać worker",
      cronHint: "Worker będzie uruchamiany co {minutes} min (cron: {schedule}).",
      cronSchedule: "Cron schedule",
      cronActive: "Cron aktywny",
      save: "Zapisz ustawienia maili",
      currentCron: "Cron",
      workerActions: "Ręczne akcje workera",
      runLimit: "Ile maili wysłać teraz",
      runLimitHint: "Maksymalnie tyle rekordów weźmie worker przy ręcznym uruchomieniu.",
      ...
      skippedPill: "pominięty",
      skipReasonUserFlag: "wyłączone powiadomienia",
      skipReasonSuppression: "globalny unsubscribe",
      statsSent: "wysłane: {count}",
      statsFailed: "błędy: {count}",
      statsSkipped: "pominięte: {count}",
      statsSkippedFlag: "flaga: {count}",
      ...
      emptyQueue: "Brak rekordów w kolejce dla wybranego filtra.",
      emptyLogs: "Brak logów dla wybranego filtra.",
      rows: "Wiersze: {count}",
      workerInvoked: "Worker uruchomiony",
      singleInvoked: "Wysłanie maila uruchomione",
      runNow: "Wyślij teraz",
      sendingNow: "Wysyłanie...",
      selectRows: "Zaznacz rekordy kolejki",
      cronUnavailable: "Cron niedostępny w tej bazie",
      cronNotConfigured: "Cron nie jest skonfigurowany",
      active: "Aktywny",
      inactive: "Nieaktywny",
    ...
    marketplace: {
      ...
      syncProgress: "Synchronizuję… {synced} / {total}",
      syncNoErrors: "Brak błędów.",
      syncDeleted: ", usunięto {n}",
      syncErrors: "błędów",
      syncCleanup: "Czyszczę usunięte gry…",
      attachExpired: "— załącznik wygasł",
      loadingConv: "Ładowanie…",
      telegramTestSent: "Testowe powiadomienie wysłane.",
      telegramTestToast: "Testowe powiadomienie Telegram wysłane.",
      marketPreview: "Podgląd",
      marketApprove: "Zatwierdź",
      marketReject: "Odrzuć",
      assignNewSubjectPlaceholder: "Temat nowego zgłoszenia",
      assignQuoteLabel: "Dołącz cytat wiadomości użytkownika w odpowiedzi",
      ticketBadgeTitle: "Przejdź do zgłoszenia",
      convFrom: "Od:",
      convTo: "Do:",
    ...
    reports: {
      ...
      trashNote: "Elementy starsze niż 30 dni są usuwane automatycznie",
      assignReport: "Przydziel zgłoszenie",
      createReport: "Nowe zgłoszenie",
      trashMsg: "Do kosza",
      restore: "Przywróć",
      deleteForever: "Usuń na zawsze",
      reportAssigned: "Zgłoszenie przydzielone",
      sourceEmail: "Email",
      sourceForm: "Formularz",
      sourceCompose: "Wiadomość",
      replyBtn: "Odpowiedz",
