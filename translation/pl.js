const pl = {
  ...
  logoEditor: {
    ...
    draw: {
      ...
      tooltips: {
        ...
        ellipse: "Elipsa\nRysuj elipsy i koła",
        poly: "Wielokąt\nRysuj wielokąty",
        polyHint: "Enter kończy",
        undo: "Cofnij",
        redo: "Ponów",
        duplicate: "Duplikuj\nPowiel zaznaczone obiekty",
      ...
      ui: {
        ...
        outlineLabel: "Obrys",
        radiusLabel: "Roz.",
        lineHeightLabel: "Linia",
        letterSpacingLabel: "Odst.",
        bold: "B",
        italic: "I",
        underline: "U",
        fontFallback: "Font",
  ...
  control: {
    ...
    sfxDesc: {
      ...
      round_transition2: "Przejście między rundami (wariant)",
      ...
      bells: "Przejście wyniku na tablicę drużyny",
    },
  ...
  settings: {
    ...
    maintenance: {
      ...
      useStandardText: "Standardowy tekst dla każdego z trybów",
      customCommentTitle: "Własny komentarz",
      customCommentPlaceholder: "Dodatkowa informacja dla użytkowników...",
      customCommentHint: "Użyj #timer, aby wstawić odliczanie/czas powrotu.",
      previewBtn: "👁 Podgląd strony maintenance",
      previewTitleModal: "Podgląd strony maintenance",
    },
    preview: {
      label: "Podgląd",
    ...
    mail: {
      ...
      emailSignatureTitle: "Podpis w odpowiedziach",
      emailSignatureHint: "Wybierz domyślne powitanie i pożegnanie dla odpowiedzi na zgłoszenia",
      greetingLabel: "Powitanie",
      farewellLabel: "Pożegnanie",
      includeSignatureInCompose: "Automatycznie dodawaj podpis w oknie odpowiedzi",
      greetingCustomPlaceholder: "Własne powitanie (opcjonalnie)",
      farewellCustomPlaceholder: "Własne pożegnanie (opcjonalnie)",
    ...
    reports: {
      ...
      compose: {
        ...
        templates: {
          custom: "Własny",
          info: "Podziękowanie",
          received: "Potwierdzenie otrzymania",
          resolved: "Zgłoszenie rozwiązane",
          pending: "W trakcie realizacji",
          moreInfo: "Prośba o informacje",
          followup: "Follow-up",
          closed: "Zamknięcie zgłoszenia",
          thanks: "Podziękowanie",
        },
      },
    },
    marketing: {
      title: "Wysyłka marketingowa",
      ...
      subjectAutoHint: "Temat ustawiony automatycznie — możesz go zmienić.",
      bodyLabel: "Treść wiadomości",
      previewLabel: "Podgląd e-maila",
      previewBtn: "Odśwież podgląd",
      showPreview: "Pokaż podgląd",
      hidePreview: "Ukryj podgląd",
      recipientsLabel: "Odbiorcy",
      recipientsHint: "Wpisz adresy e-mail oddzielone przecinkami lub nową linią, lub wczytaj z pliku (.txt/.csv).",
      loadFile: "Wczytaj z pliku",
      parseBtn: "Waliduj listę",
      validatedList: "Zwalidowana lista",
      clearList: "Wyczyść",
      validCount: "poprawnych",
      invalidCount: "niepoprawnych",
      invalidEmails: "Niepoprawne:",
      noValid: "Brak poprawnych adresów.",
      sendBtn: "Wyślij do odbiorców",
      sending: "Wysyłam…",
      sent: "Dodano do kolejki:",
      errSubject: "Podaj temat.",
