const pl = {
  ...
  control: {
    ...
    finalEndName: "Koniec",
    finalEndHint: "To konic finału. Na wyświetlaczu pokażemy logo programu, punkty zwycięskiej drużyny lub kwotę wygranej (w zależności co wybrałeś w ustawiniach).",
  ...
  settings: {
    ...
    marketing: {
      ...
      tplInvitation: "Zaproszenie do rejestracji",
      tplEvent: "Event / Wesele",
