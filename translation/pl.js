const pl = {
  ...
  control: {
    ...
    teamHint: "Tutaj należy wprowadzić nazwy drużyn i wybrać kolory.",
    ...
    summaryQWillRandom: "Zostaną wylosowane przy starcie gry",
    summaryQNoOrder: "Brak wybranej kolejności",
