const pl = {
  ...
  control: {
    ...
    soundSection: "Dźwięk",
    soundSourceLabel: "Odtwarzaj dźwięk na Wyświetlaczu zamiast Panelu sterowania",
    soundSourceHint: "Domyślnie dźwięki gry odtwarzają się z tego urządzenia (Panel sterowania).",
    soundSourceDisplayHint: "Dźwięki będą odtwarzane z Wyświetlacza — pojawi się tam przycisk „Odblokuj dźwięk”, który trzeba raz kliknąć, zanim dźwięk zacznie grać.",
