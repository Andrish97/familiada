const en = {
  ...
  control: {
    ...
    teamHint: "Enter team names and choose colors here.",
    teamALabel: "Team A",
    ...
    stepGameSettings: "Questions and gameplay settings",
    sectionFinal: "Final",
    finalQuestionsMode: "Final questions",
    finalRandom: "Random",
    finalPick: "Pick",
    stepFinalPick: "Pick final questions",
    stepRoundsPick: "Round questions order",
    roundsPickHint: "Set the order of questions for subsequent rounds. Final questions are excluded.",
    selected: "selected",
    ...
    summaryQRandom: "Drawing in progress…",
    summaryQNone: "No questions",
    summaryQWillRandom: "Will be drawn at game start",
    summaryQNoOrder: "No order selected",
    ...
    shareDeviceModal: {
      ...
      mailBody: "{owner} shared a device with you: {type} (game: {game}). Open Connect device to see it.",
    },
