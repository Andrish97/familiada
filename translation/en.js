const en = {
  ...
  resourceLock: {
    ...
    forbiddenTitle: "Editing access lost",
  ...
  guestReminder: {
    text: "Your guest account will be deleted in a few days. Save your data before you lose it.",
    link: "Migrate now",
  ...
  account: {
    ...
    migratePendingHint: "We sent a confirmation link to {email}. Click it to finish the migration.",
    migrateResend: "Resend",
    migrateCancel: "Cancel",
    statusMigrating: "Sending confirmation link…",
    statusMigrateSent: "Sent! Check your email to finish the migration.",
    statusMigrateResending: "Resending…",
    ...
    deleteHintGuest: "This operation is irreversible and will delete all data for this guest account.",
    deletePlaceholder: "Password",
    deleteButton: "Delete account and data",
    deleteGuestModalTitle: "Delete guest account?",
    deleteGuestModalText: "This operation is irreversible — all games, question banks and files will be permanently deleted.",
    deleteGuestModalOk: "Delete",
    ...
    emailNotifSavedOn: "Email notifications have been turned on.",
    emailNotifSavedOff: "Email notifications have been turned off.",
    emailNotifSaveFailed: "Could not save notification settings. Please try again.",
    demo: {
  ...
  bases: {
    ...
    export: {
      steps: {
        ...
        categoryTags: "Export: folder tags…",
        download: "Downloading…",
      },
      count: "Count: {count}",
      errorStep: "Base export failed.",
    ...
    loadFailed: "Could not load question bases. Refresh the page.",
    proposed: {
      accept: "Accept",
      decline: "Decline",
      ...
      expired: "This invite has expired or no longer exists.",
      handled: "This invite has already been accepted or declined.",
    },
    sections: {
      mine: "My bases",
      newBase: "New base",
  ...
  games: {
    ...
    exportBase: {
      ...
      progress: {
        ...
        done: "Export to base completed.",
        errorLabel: "Export to base failed.",
    ...
    exportFile: {
      ...
      progress: {
        ...
        done: "Game file saved.",
        errorLabel: "Could not save the game file.",
        failed: "Export failed.",
      },
    },
    nameModal: {
  ...
  editor: {
    ...
    import: {
      ...
      progress: {
        ...
        done: "Questions have been imported.",
        errorStep: "Question import failed.",
      },
  ...
  logoEditor: {
    ...
    text: {
      ...
      fits: "fits",
      notFits: "doesn't fit",
      fixInvalidChars: "Remove or replace the invalid characters.",
      fixTooWide: "The text doesn't fit — shorten it.",
    },
    draw: {
      colors: {
        black: "black",
      ...
      tooltips: {
        ...
        preview: "Preview\nHow the logo will look on the display",
      },
      errors: {
    ...
    image: {
      ...
      gammaLabel: "Gamma:",
      blackLabel: "Black point:",
      whiteLabel: "White point:",
      ditherLabel: "Dither:",
      straighten: "Straighten",
      straightenLabel: "Straighten:",
      rotateLeft: "Rotate left by 90°",
      rotateRight: "Rotate right by 90°",
      invert: "Invert",
      reset: "Reset",
      displayArea: "Display area",
      previewTitle: "Preview as on the display",
      previewHint: "Click the preview to open it full screen.",
      loadError: "Couldn't load the image.",
      errors: {
        notLogged: "You must be logged in to save an image.",
        storageFailed: "Couldn't upload the image: {error}",
        stillLoading: "The image is still loading — try again in a moment.",
        loadFailed: "Couldn't load this logo's image. Choose the image again — saving is disabled until then, so the logo isn't overwritten with a blank one.",
    ...
    create: {
      ...
      textTitle: "Text",
      textSubtitle: "Text in the classic Familiada logo font",
      drawTitle: "Drawing",
      drawSubtitle: "Draw, add shapes and text",
      imageTitle: "Image",
      imageSubtitle: "Your image turned into display dots",
    },
    preview: {
      title: "Preview",
    ...
    rename: {
      title: "Rename",
      sub: "Enter a new name and save.",
      placeholder: "Name…",
      emptyError: "Name cannot be empty.",
      failed: "Couldn't rename the logo.",
    },
    import: {
      title: "Import logo",
      confirm: "Import",
    ...
    errors: {
      ...
      invalidJson: "This is not a logo file (.famlogo).",
      pixSize: "The logo file has the wrong size: {actualW}×{actualH} instead of {expectedW}×{expectedH}.",
  ...
  control: {
    ...
    roundsNextRoundBtn: "Go to next round",
    roundsGoToFinalBtn: "Go to the final",
    roundsGoToGameEndBtn: "Go to end of game",
    ...
    finalUi: {
      ...
      occupied: "taken",
      mapInputLabel: "Entered",
      mapMissSubLabel: "(player's answer)",
    },
    sfxCustom: "Custom",
    ingameGuard: {
    ...
    stepDuelTitle: "Round {round} — duel",
    stepPlayTitle: "Round {round} — play",
    stepStealTitle: "Round {round} — steal",
    physicalConfirmTeam: "Confirm: {name}",
    roundsPassControl: "Pass control",
    ...
    endHintMoney: "The outro will play and the winning prize amount will appear on the display.",
    endHintPoints: "The outro will play and the score in points will appear on the display.",
    restartGame: "Start over",
    returnToMyGames: "Back to my games",
    finalEntryHeading: "Player {round} answers",
    finalEntryStepLabel: "Final — player {round}, entry",
    finalMappingStepLabel: "Final — mapping {n}/5",
    finalP2StartStepLabel: "Final — round 2 start",
    finalTimerStopShort: "Stop",
    finalTimerUsed: "Time used",
    finalRevealAnswerLabel: "Show answer",
    finalRevealPointsLabel: "Show points",
    displayPreviewTitle: "Display preview",
    unhandledStepDebug: "Unhandled step: {step}",
  },
  security: {
