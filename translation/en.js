const en = {
  ...
  settings: {
    ...
    mail: {
      ...
      batchMax: "Batch max",
      workerLimit: "Worker limit (default)",
      cronSchedule: "Cron schedule",
      cronActive: "Cron active",
      save: "Save mail settings",
      currentCron: "Cron",
      workerActions: "Manual worker actions",
      runLimit: "Manual run limit",
      runWorker: "Run worker",
      retryFailed: "Requeue failed + run",
      retrySelected: "Requeue selected + run",
      workerHint: "Manual actions work on `mail_queue` and invoke `invoke_mail_worker(...)`.",
