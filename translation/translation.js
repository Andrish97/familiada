const LANG_LOADERS = {
  pl: async () => (await import('./pl.js?v=v2026-09-26T13355')).default,
  en: async () => (await import('./en.js?v=v2026-09-26T13355')).default,
  uk: async () => (await import('./uk.js?v=v2026-09-26T13355')).default,
};
