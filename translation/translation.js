const LANG_LOADERS = {
  pl: async () => (await import('./pl.js?v=v2026-07-12T21444')).default,
  en: async () => (await import('./en.js?v=v2026-07-12T21444')).default,
  uk: async () => (await import('./uk.js?v=v2026-07-12T21444')).default,
};
