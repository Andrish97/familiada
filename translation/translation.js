const LANG_LOADERS = {
  pl: async () => (await import('./pl.js?v=v2026-07-12T22391')).default,
  en: async () => (await import('./en.js?v=v2026-07-12T22391')).default,
  uk: async () => (await import('./uk.js?v=v2026-07-12T22391')).default,
};
