const LANG_LOADERS = {
  pl: async () => (await import('./pl.js?v=v2026-09-03T06084')).default,
  en: async () => (await import('./en.js?v=v2026-09-03T06084')).default,
  uk: async () => (await import('./uk.js?v=v2026-09-03T06084')).default,
};
