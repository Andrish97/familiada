const LANG_LOADERS = {
  pl: async () => (await import('./pl.js?v=v2026-09-09T10465')).default,
  en: async () => (await import('./en.js?v=v2026-09-09T10465')).default,
  uk: async () => (await import('./uk.js?v=v2026-09-09T10465')).default,
};
