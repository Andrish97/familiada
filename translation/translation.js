const LANG_LOADERS = {
  pl: async () => (await import('./pl.js?v=v2026-09-10T18284')).default,
  en: async () => (await import('./en.js?v=v2026-09-10T18284')).default,
  uk: async () => (await import('./uk.js?v=v2026-09-10T18284')).default,
};
