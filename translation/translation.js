const LANG_LOADERS = {
  pl: async () => (await import('./pl.js?v=v2026-08-27T21492')).default,
  en: async () => (await import('./en.js?v=v2026-08-27T21492')).default,
  uk: async () => (await import('./uk.js?v=v2026-08-27T21492')).default,
};
