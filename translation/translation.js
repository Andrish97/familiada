const LANG_LOADERS = {
  pl: async () => (await import('./pl.js?v=v2026-08-27T22253')).default,
  en: async () => (await import('./en.js?v=v2026-08-27T22253')).default,
  uk: async () => (await import('./uk.js?v=v2026-08-27T22253')).default,
};
