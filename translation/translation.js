const LANG_LOADERS = {
  pl: async () => (await import('./pl.js?v=v2026-09-14T15291')).default,
  en: async () => (await import('./en.js?v=v2026-09-14T15291')).default,
  uk: async () => (await import('./uk.js?v=v2026-09-14T15291')).default,
};
