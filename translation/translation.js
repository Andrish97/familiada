const LANG_LOADERS = {
  pl: async () => (await import('./pl.js?v=v2026-08-31T18315')).default,
  en: async () => (await import('./en.js?v=v2026-08-31T18315')).default,
  uk: async () => (await import('./uk.js?v=v2026-08-31T18315')).default,
};
