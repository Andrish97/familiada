const LANG_LOADERS = {
  pl: async () => (await import('./pl.js?v=v2026-07-15T22063')).default,
  en: async () => (await import('./en.js?v=v2026-07-15T22063')).default,
  uk: async () => (await import('./uk.js?v=v2026-07-15T22063')).default,
};
