const uk = {
  ...
  auth: {
    ...
    errSecurityOnceEvery: "З міркувань безпеки ви можете запитувати це лише раз на {seconds} секунд.",
    errEmailRateLimitExceeded: "Перевищено ліміт надсилання e-mail. Спробуйте пізніше.",
  ...
  index: {
    ...
    errResetCooldown: "Посилання вже надіслано. Спробуйте знову через {time}.",
  },
  confirm: {
  ...
  account: {
    ...
    emailNoAccessHint: "Немає доступу до поточного e-mail? Експортуйте важливі дані (ігри, бази, логотипи), видаліть акаунт, створіть новий з правильним e-mail і потім імпортуйте назад.",
    emailPendingTitle: "Зміна e-mail у процесі",
    emailPendingText: "Новий e-mail: {email}. Завершіть зміну, підтвердивши посилання (надіслані на стару й нову адресу).",
    ...
    emailNotifDisableConfirm: "Вимкнути e-mail сповіщення? Усі запрошення й завдання й надалі будуть доступні на сайті.",
    ...
    statusError: "Помилка.",
    errInvalidEmail: "Вкажіть коректний e-mail.",
    errEmailPending: "Зміна e-mail уже в процесі. Спочатку завершіть її або скасуйте.",
    errNoPendingEmail: "Немає активної зміни e-mail.",
    cooldown: "Повторна дія можлива через {time}.",
    errCooldown: "Занадто швидко. Спробуйте знову через {time}.",
    errPasswordMismatch: "Паролі не збігаються.",
  ...
  bases: {
    ...
    mail: {
      ...
      footer: "Якщо це не ви, будь ласка, проігноруйте це повідомлення.",
      linkLabel: "Якщо кнопка не працює, скопіюйте посилання:",
  ...
  pollsHub: {
    ...
    modal: {
      ...
      updateSubscription: {
        ...
        textPending: "Ви впевнені, що хочете відхилити це запрошення?",
        textActive: "Ви впевнені, що хочете скасувати цю підписку?",
      ...
      declineTask: {
        ...
        text: "Ви впевнені, що хочете відхилити це завдання?",
        ok: "Відхилити",
        cancel: "Скасувати",
      },
      tokenMismatch: {
  ...
  logoEditor: {
    ...
    list: {
      title: "Ваші логотипи",
      hint: "Клікніть плитку, щоб її вибрати.",
      preview: "Перегляд",
      activate: "Активувати",
      export: "Експорт",
      import: "Імпорт",
    ...
    text: {
      ...
      fixTooWide: "Напис не вміщується — скоротіть текст.",
    },
    textPix: {
      font: "Шрифт",
      systemFont: "Системна",
      ...
      tooltips: {
        ...
        alignCycleExtra: "Клацайте: ліво → центр → право",
      },
      errors: {
      ...
      warnings: {
        clipped: "Схоже, обрізається — зменште розмір або скоротіть текст.",
    ...
    image: {
      ...
      previewHint: "Клікніть перегляд, щоб відкрити на весь екран.",
    ...
    create: {
      title: "Новий логотип",
      subtitle: "Оберіть режим створення.",
      textTitle: "Напис",
    ...
    import: {
      title: "ІМПОРТ…",
      subtitle: "Не закривайте сторінку. Триває імпорт.",
      steps: {
        readFile: "Читаю файл…",
  ...
  baseExplorer: {
    ...
    tags: {
      ...
      editModeHelp: "Змініть назву та колір тегу.",
      createModeHelp: "Додайте новий тег.",
      errors: {
        noSpaces: "Назва не може містити пробілів. Використайте _ замість пробілів.",
        allowedChars: "Дозволені символи: літери, цифри та _",
        duplicate: "Такий тег уже існує. Виберіть іншу назву.",
    ...
    rename: {
      title: "Перейменувати",
      help: "Введіть нову назву та збережіть.",
    ...
    export: {
      title: "Експорт гри",
      subtitle:
        "Виберіть щонайменше 10 питань. Червоні не відповідають вимогам обраного типу — зніміть їх або виправте дані.",
      ...
      errors: {
        ...
        pickMin: "Виберіть щонайменше {count} питань.",
    ...
    question: {
      ...
      textPlaceholder: "Введіть текст питання…",
    ...
    list: {
      ...
      resizeColumn: "Перетягніть, щоб змінити ширину стовпця",
    },
    menu: {
      show: "Показати",
      addTag: "Додати тег…",
    ...
    errors: {
      ...
      selectItemsRight: "Виберіть папки або питання справа.",
      ...
      treeLockedSearch:
        "Під час пошуку дерево заблоковане. Натисніть ✕ щоб очистити або клацніть поза полем пошуку.",
      treeLockedSelection:
        "У вас вибрані Теги/Категорії. Очистіть вибір ліворуч (клік по фону панелі), щоб користуватися деревом.",
      tagsLockedSearch:
        "Під час пошуку панель Теги/Категорії заблокована. Натисніть ✕ щоб очистити або клацніть поза полем пошуку.",
      searchLockedSelection:
        "У вас вибрані Теги/Категорії — пошук заблоковано. Очистіть вибір ліворуч (клік по фону панелі), щоб шукати.",
    },
    confirm: {
