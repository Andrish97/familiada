    ...
    content: {
     ...
     <p class="m-p">
      ...
      subscriptions: `<p class="m-p">
        Вкладка «Підписки» охоплює все, що стосується взаємодії між користувачами:
        запрошення підписників, прийняття запрошень, повторні надсилання та видалення зв’язків.
      </p>
      <p class="m-p">
        На практиці підписки прискорюють роботу — активним підписникам можна в один клік
        поділитися опитуванням і швидко поділитися базою запитань без ручного копіювання посилань.
      </p>
      <p class="m-p">
        Якщо під час запрошення вводиш логін, система спочатку перевіряє, чи існує такий користувач.
        Якщо ні — показується повідомлення. Для e-mail можна запросити також незареєстровану особу.
      </p>`,
      logo: `<p class="m-p">
