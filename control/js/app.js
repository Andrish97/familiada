...
import { guardDesktopOnly } from "../../js/core/device-guard.js?v=v2026-07-16T22505";
...
import { requireAuth, signOut } from "../../js/core/auth.js?v=v2026-07-16T22505";
import { setTopbarAccount } from "../../js/core/topbar-controller.js?v=v2026-07-16T22505";
import { isGuestUser } from "../../js/core/guest-mode.js?v=v2026-07-16T22505";
import { sb } from "../../js/core/supabase.js?v=v2026-07-16T22505";
import { rt } from "../../js/core/realtime.js?v=v2026-07-16T22505";
import { validateGameReadyToPlay, loadGameBasic, loadQuestions, loadAnswers } from "../../js/core/game-validate.js?v=v2026-07-16T22505";
import { unlockAudio, isAudioUnlocked, playSfx, setCurrentGameId, loadSfxManifest, initSfx, applySfxGameSettings, loadSfxFromCloud, getSfxCustomFiles, getSfxCategories, getSfxVariant, getSfxVolume, isSfxPlaying, stopSfx, onSfxEnd, setSessionSfxVolume } from "../../js/core/sfx.js?v=v2026-07-16T22505";
import { listGameSounds } from "../../js/core/sfx-cloud.js?v=v2026-07-16T22505";
import { createStore } from "./store.js?v=v2026-07-16T22505";
import { createUI } from "./ui.js?v=v2026-07-16T22505";
import { createDevices } from "./devices.js?v=v2026-07-16T22505";
import { createPresence } from "./presence.js?v=v2026-07-16T22505";
import { createDisplay } from "./display.js?v=v2026-07-16T22505";
import { createRounds } from "./gameRounds.js?v=v2026-07-16T22505";
import { createFinal } from "./gameFinal.js?v=v2026-07-16T22505";
import { initShareDevice } from "./share-device.js?v=v2026-07-16T22505";
