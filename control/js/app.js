...
import { getUiLang, initI18n, t } from "../../translation/translation.js?v=v2026-09-14T21091";
import { v as cacheBust } from "../../js/core/cache-bust.js?v=v2026-09-14T21091";
import { guardDesktopOnly } from "../../js/core/device-guard.js?v=v2026-09-14T21091";
...
import { requireAuth, signOut } from "../../js/core/auth.js?v=v2026-09-14T21091";
import { setTopbarAccount } from "../../js/core/topbar-controller.js?v=v2026-09-14T21091";
import { isGuestUser } from "../../js/core/guest-mode.js?v=v2026-09-14T21091";
import { sb } from "../../js/core/supabase.js?v=v2026-09-14T21091";
import { rt } from "../../js/core/realtime.js?v=v2026-09-14T21091";
import { validateGameReadyToPlay, loadGameBasic, loadQuestions, loadAnswers } from "../../js/core/game-validate.js?v=v2026-09-14T21091";
import { unlockAudio, isAudioUnlocked, playSfx, setCurrentGameId, loadSfxManifest, initSfx, applySfxGameSettings, loadSfxFromCloud, getSfxCustomFiles, getSfxCategories, getSfxVariant, getSfxVolume, isSfxPlaying, stopSfx, onSfxEnd, setSessionSfxVolume } from "../../js/core/sfx.js?v=v2026-09-14T21091";
import { listGameSounds } from "../../js/core/sfx-cloud.js?v=v2026-09-14T21091";
import { createStore } from "./store.js?v=v2026-09-14T21091";
import { createUI } from "./ui.js?v=v2026-09-14T21091";
import { createDevices } from "./devices.js?v=v2026-09-14T21091";
import { createPresence } from "./presence.js?v=v2026-09-14T21091";
import { createDisplay } from "./display.js?v=v2026-09-14T21091";
import { createRounds } from "./gameRounds.js?v=v2026-09-14T21091";
import { createFinal } from "./gameFinal.js?v=v2026-09-14T21091";
import { initShareDevice } from "./share-device.js?v=v2026-09-14T21091";
import { loadFont5x7, buildLogoPreviewCanvas } from "../../js/core/logo-preview.js?v=v2026-09-14T21091";
import { sessionStart, sessionEnd, sessionLogError } from "./sessionTracking.js?v=v2026-09-14T21091";
