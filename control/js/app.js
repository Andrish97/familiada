...
import { guardDesktopOnly } from "../../js/core/device-guard.js?v=v2026-07-16T22572";
...
import { requireAuth, signOut } from "../../js/core/auth.js?v=v2026-07-16T22572";
import { setTopbarAccount } from "../../js/core/topbar-controller.js?v=v2026-07-16T22572";
import { isGuestUser } from "../../js/core/guest-mode.js?v=v2026-07-16T22572";
import { sb } from "../../js/core/supabase.js?v=v2026-07-16T22572";
import { rt } from "../../js/core/realtime.js?v=v2026-07-16T22572";
import { validateGameReadyToPlay, loadGameBasic, loadQuestions, loadAnswers } from "../../js/core/game-validate.js?v=v2026-07-16T22572";
import { unlockAudio, isAudioUnlocked, playSfx, setCurrentGameId, loadSfxManifest, initSfx, applySfxGameSettings, loadSfxFromCloud, getSfxCustomFiles, getSfxCategories, getSfxVariant, getSfxVolume, isSfxPlaying, stopSfx, onSfxEnd, setSessionSfxVolume } from "../../js/core/sfx.js?v=v2026-07-16T22572";
import { listGameSounds } from "../../js/core/sfx-cloud.js?v=v2026-07-16T22572";
import { createStore } from "./store.js?v=v2026-07-16T22572";
import { createUI } from "./ui.js?v=v2026-07-16T22572";
import { createDevices } from "./devices.js?v=v2026-07-16T22572";
import { createPresence } from "./presence.js?v=v2026-07-16T22572";
import { createDisplay } from "./display.js?v=v2026-07-16T22572";
import { createRounds } from "./gameRounds.js?v=v2026-07-16T22572";
import { createFinal } from "./gameFinal.js?v=v2026-07-16T22572";
import { initShareDevice } from "./share-device.js?v=v2026-07-16T22572";
