...
| `js/pages/builder-import-export.js` | import/eksport całych gier | ✅ import bezpieczny z natury (zawsze nowe wiersze); eksport dostał busy-check w `builder.js` (czyta grę/pytania/odpowiedzi w kilku zapytaniach po kolei — bez tego mógłby złapać rozjechany stan przy edycji w tym samym momencie) — 🔄 e2e w toku |
