...
import { initFullscreenButton } from "../../display/js/fullscreen.js?v=v2026-09-25T07274";
import { initI18n, setUiLang } from "../../translation/translation.js?v=v2026-09-25T07274";
import { startKeepAlive } from "../../js/core/keep-alive.js?v=v2026-09-25T07274";
import { sb } from "../../js/core/supabase.js?v=v2026-09-25T07274";
import { createScene } from "./scene.js?v=v2026-09-25T07274";
import { createQRController } from "./qr.js?v=v2026-09-25T07274";
import { createSubscription } from "../../js/core/game-state-subscribe.js?v=v2026-09-25T07274";
import { createRenderer } from "./render.js?v=v2026-09-25T07274";
import { createDisplaySoundReactor } from "./soundReactor.js?v=v2026-09-25T07274";
import { loadSfxManifest, initSfx, setCurrentGameId, applySfxGameSettings, unlockAudio, isAudioUnlocked, getSfxDuration } from "../../js/core/sfx.js?v=v2026-09-25T07274";
