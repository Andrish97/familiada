...
} from "./state.js?v=v2026-09-03T215015";

import { importGame } from "../../js/pages/builder-import-export.js?v=v2026-09-03T06084";

import { renderAll, renderToolbar, renderList, renderTree, renderTags } from "./render.js?v=v2026-09-03T215015";
...
import {
  ...
  listQuestionTags,
  listCategoryTags
} from "./repo.js?v=v2026-09-03T215015";

import { showContextMenu, hideContextMenu } from "./context-menu.js?v=v2026-09-03T215015";
import { openTagsModal } from "./tags-modal.js?v=v2026-09-03T215015";
import { initExportModal } from "./export-modal.js?v=v2026-09-03T215015";
import { initQuestionModal } from "./question-modal.js?v=v2026-09-03T215015";
import { sb } from "../../js/core/supabase.js?v=v2026-09-03T06084";
import { updateChecked, updateCheckedMany, ROW_GONE } from "../../js/core/db-guard.js?v=v2026-09-03T06084";
...
import { addLongPress, addDoubleTap, isTouchContextMenuWindow } from "./mobile.js?v=v2026-09-03T215015";
...
export function wireActions({ state }) {
  ...
  let marqueeToggle = false;    // touch: XOR z bazą
