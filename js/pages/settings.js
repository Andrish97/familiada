...
import { alertModal, confirmModal, promptModal } from "../core/modal.js?v=v2026-07-17T09161";
...
const TOOLS_MANIFEST = "/settings-tools/tools.json?v=v2026-07-17T09161";
const POLL_MS = 15000;
...
<head>
  ...
  <link rel="stylesheet" href="/css/maintenance.css?v=v2026-07-17T09161"/>
  <style>
...
(async () => {
  ...
  // MARKETING CONTACTS
  // ═══════════════════════════════════════════════════════════
  const { rt } = await import("../core/realtime.js?v=v2026-07-17T09161");
