...
import { v as cacheBust } from "../core/cache-bust.js?v=v2026-06-03T21150";

const API_BASE = "/_admin_api";
const TOOLS_MANIFEST = "/settings-tools/tools.json?v=v2026-06-03T21150";
const POLL_MS = 15000;
...
<head>
  ...
  <link rel="stylesheet" href="/css/maintenance.css?v=v2026-06-03T21150"/>
  <style>
...
(async () => {
  ...
  // MARKETING CONTACTS
  // ═══════════════════════════════════════════════════════════
  const { rt } = await import("../core/realtime.js?v=v2026-06-03T21150");
