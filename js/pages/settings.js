...
import { alertModal, confirmModal, promptModal } from "../core/modal.js?v=v2026-09-02T20564";
import { sb } from "../core/supabase.js?v=v2026-09-02T20564";
import { v as cacheBust } from "../core/cache-bust.js?v=v2026-09-02T20564";

const API_BASE = "/_admin_api";
const TOOLS_MANIFEST = "/settings-tools/tools.json?v=v2026-09-02T20564";
const POLL_MS = 15000;
...
<head>
  ...
  <link rel="stylesheet" href="/css/base.css?v=v2026-09-02T20564"/>
  <link rel="stylesheet" href="/css/maintenance.css?v=v2026-09-02T20564"/>
  <style>
...
(async () => {
  ...
  // MARKETING CONTACTS
  // ═══════════════════════════════════════════════════════════
  const { rt } = await import("../core/realtime.js?v=v2026-09-02T20564");
