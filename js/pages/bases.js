...
import { addRenameGesture } from "../core/rename-gesture.js?v=v2026-09-23T19462";

import { sb, SUPABASE_URL } from "../core/supabase.js?v=v2026-09-23T19462";
import { updateChecked, ROW_GONE } from "../core/db-guard.js?v=v2026-09-23T19462";
import { requireAuth } from "../core/auth.js?v=v2026-09-23T19462";
import { alertModal, confirmModal } from "../core/modal.js?v=v2026-09-23T19462";
import { isGuestUser, hideForGuest } from "../core/guest-mode.js?v=v2026-09-23T19462";
import { initUiSelect } from "../core/ui-select.js?v=v2026-09-23T19462";
import { getUiLang, initI18n, t, withLangParam } from "../../translation/translation.js?v=v2026-09-23T19462";
import { initTopbarAccountDropdown } from "../core/topbar-controller.js?v=v2026-09-23T19462";
import { enterModalSheet, exitModalSheet, isSheetViewport, handleSheetBack } from "../core/modal-sheet.js?v=v2026-09-23T19462";
