// js/pages/game-settings2.js — kopia game-settings.js dedykowana dla modala
...
import { t, getUiLang } from "../../translation/translation.js?v=v2026-09-10T18071";
import { setTopbarAccount } from "../core/topbar-controller.js?v=v2026-09-10T18071";
import { sb } from "../core/supabase.js?v=v2026-09-10T18071";
import { loadQuestions } from "../core/game-validate.js?v=v2026-09-10T18071";
import { loadFont5x7, buildLogoPreviewCanvas } from "../core/logo-preview.js?v=v2026-09-10T18071";
...
import { buildDisplayPreviewRow } from "../../shared/previewRow.js?v=v2026-09-10T18071";
import {
...
} from "../core/sfx.js?v=v2026-09-10T18071";
import {
  uploadGameSound, deleteGameSound, deleteAllGameSounds,
} from "../core/sfx-cloud.js?v=v2026-09-10T18071";
import { guardDesktopOnly } from "../core/device-guard.js?v=v2026-09-10T18071";
import { guardResourceLock, guardResourceBusy } from "../core/resource-lock.js?v=v2026-09-10T18071";
...
async function main() {
  ...
  function buildHelpUrl() {
    ...
    url.searchParams.set("ret", `game-settings2${location.search}`);
