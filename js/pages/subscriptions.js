        ...
        if (token) {
          await fetch(MAIL_FUNCTION_URL, {
            ...
            body: JSON.stringify({
              ...
              html: buildMailHtml({
                title: t("pollsHubSubscriptions.mail.subscriptionTitle", { owner: who?.textContent || "Familiada" }),
                subtitle: t("pollsHubSubscriptions.mail.subtitle"),
                body: t("pollsHubSubscriptions.mail.subscriptionBody", { owner: who?.textContent || "Familiada" }),
                actionLabel: t("pollsHubSubscriptions.mail.subscriptionAction"),
                actionUrl: mailLink(resendData.link),
              }),
            }),
          });
        }
