...
import { initI18n, setUiLang, t, withLangParam } from "../../translation/translation.js?v=v2026-04-13T21520";
...
async function wireDemoActions(user) {
  ...
  const { sb } = await import("../core/supabase.js?v=v2026-04-13T21520");
...
async function wireAuthSoft() {
  const { requireAuth } = await import("../core/auth.js?v=v2026-04-13T21520");
