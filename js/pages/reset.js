...
import { updateUserLanguage, validatePassword, niceAuthError, getPasswordRulesText, discardCurrentGuestAccount, initPasswordToggles } from "../core/auth.js?v=v2026-05-03T22144";
...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  save.addEventListener("click", async () => {
    ...
    try{
      ...
      setTimeout(() => (location.href = withLangParam("login")), 900);
    } catch(e){
      console.error(e);
