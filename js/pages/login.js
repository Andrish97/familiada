...
} from "../core/auth.js?v=v2026-08-26T21191";
import { isGuestUser } from "../core/guest-mode.js?v=v2026-08-26T21191";
import { alertModal, confirmModal } from "../core/modal.js?v=v2026-08-26T21191";
import { getCaptchaTokenOrPrompt, isCaptchaError, preloadCaptchaApi, hasCaptcha } from "../core/captcha.js?v=v2026-08-26T21191";

import { sb } from "../core/supabase.js?v=v2026-08-26T21191";
import { cooldownEmailGet, cooldownEmailReserve } from "../core/cooldown.js?v=v2026-08-26T21191";
import { initI18n, t, getUiLang, withLangParam, applyTranslations } from "../../translation/translation.js?v=v2026-08-26T21191";
...
async function getCaptchaPromptForLogin(loginOrEmail) {
  ...
  return await getCaptchaTokenOrPrompt({ force: policy.requireCaptcha });
}
    ...
    try {
      if (mode === "register") {
        ...
        try {
          ...
          if (isCaptchaError(e)) {
            captchaToken = await getCaptchaTokenOrPrompt({ force: true });
