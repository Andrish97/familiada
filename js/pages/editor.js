// js/pages/editor.js
import { sb } from "../core/supabase.js?v=v2026-09-14T07133";
import { requireAuth } from "../core/auth.js?v=v2026-09-14T07133";
import { alertModal, confirmModal } from "../core/modal.js?v=v2026-09-14T07133";
import { parseQaText, clip as clipN } from "../core/text-import.js?v=v2026-09-14T07133";
import { canEnterEdit, RULES as GV_RULES, TYPES } from "../core/game-validate.js?v=v2026-09-14T07133";
import { guardResourceLock } from "../core/resource-lock.js?v=v2026-09-14T07133";
import { updateChecked, ROW_GONE } from "../core/db-guard.js?v=v2026-09-14T07133";
import { initI18n, t, withLangParam } from "../../translation/translation.js?v=v2026-09-14T07133";
import { initTopbarAccountDropdown } from "../core/topbar-controller.js?v=v2026-09-14T07133";
