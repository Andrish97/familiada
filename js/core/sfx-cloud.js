...
/**
 * Usuwa wszystkie pliki audio danej gry z bucketu, niezależnie od tego jakie
 * klucze sfx zostały użyte (listuje folder {userId}/{gameId}/ i kasuje zawartość).
 * Używane przy usuwaniu całej gry — nie znamy wtedy z góry listy kluczy.
 */
