...
import { isSheetViewport, enterModalSheet, exitModalSheet } from "./modal-sheet.js?v=v2026-09-25T20010";
import { icon } from "./icons.js?v=v2026-09-25T20010";
...
async function prefillEmail() {
  try {
    const { sb } = await import("./supabase.js?v=v2026-09-25T20010");
