...
import { isSheetViewport, enterModalSheet, exitModalSheet } from "./modal-sheet.js?v=v2026-09-26T13355";
import { icon } from "./icons.js?v=v2026-09-26T13355";
  ...
  return `
    <div class="modal">
      ...
      <div id="cModalSuccess" style="display:none;text-align:center;padding:16px 0">
        <div style="font-size:32px;margin-bottom:8px;color:#6ee7a8">${icon("check")}</div>
...
async function prefillEmail() {
  try {
    const { sb } = await import("./supabase.js?v=v2026-09-26T13355");
