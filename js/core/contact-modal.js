...
import { isSheetViewport, enterModalSheet, exitModalSheet } from "./modal-sheet.js?v=v2026-09-24T23131";
import { icon } from "./icons.js?v=v2026-09-24T23131";
...
async function prefillEmail() {
  try {
    const { sb } = await import("./supabase.js?v=v2026-09-24T23131");
