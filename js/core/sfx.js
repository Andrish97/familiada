...
const MANIFEST_PATH = "/audio/sounds.json?v=v2026-09-23T21015";
...
export function unlockAudio() {
  ...
  try {
    const a = new Audio();
    a.volume = 0;
    a.src = "/audio/reveal/classic.mp3?v=v2026-09-23T21015";
    a.play().catch(() => {});
    unlocked = true;
    return true;
  } catch { return false; }
 ...
 * volumes: { key: 0–100 }, variants: { key: "classic.mp3?v=v2026-09-23T21015" }
 */
