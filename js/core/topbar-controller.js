...
import { signOut } from './auth.js?v=v2026-04-05T15190';
import { isGuestUser } from './guest-mode.js?v=v2026-04-05T15190';
import { t, withLangParam } from '../../translation/translation.js?v=v2026-04-05T15190';
...
export async function autoInitTopbarAuthButton(btn = document.getElementById('btnLogout')) {
  ...
  const { getUser } = await import('./auth.js?v=v2026-04-05T15190');
  if (btn.dataset.topbarAuthReady === '1') return;
