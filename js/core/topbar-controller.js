...
import { signOut } from './auth.js?v=v2026-06-09T17173';
import { isGuestUser } from './guest-mode.js?v=v2026-06-09T17173';
import { t, withLangParam } from '../../translation/translation.js?v=v2026-06-09T17173';
...
export async function autoInitTopbarAuthButton(btn = document.getElementById('btnLogout')) {
  ...
  const { getUser } = await import('./auth.js?v=v2026-06-09T17173');
  if (btn.dataset.topbarAuthReady === '1') return;
