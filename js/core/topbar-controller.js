...
import { signOut } from './auth.js?v=v2026-09-08T18231';
import { isGuestUser } from './guest-mode.js?v=v2026-09-08T18231';
import { t, withLangParam } from '../../translation/translation.js?v=v2026-09-08T18231';
...
export async function autoInitTopbarAuthButton(btn = document.getElementById('btnLogout')) {
  ...
  const { getUser } = await import('./auth.js?v=v2026-09-08T18231');
  if (btn.dataset.topbarAuthReady === '1') return;
