...
import { signOut } from './auth.js?v=v2026-07-17T09192';
import { isGuestUser } from './guest-mode.js?v=v2026-07-17T09192';
import { t, withLangParam } from '../../translation/translation.js?v=v2026-07-17T09192';
...
export async function autoInitTopbarAuthButton(btn = document.getElementById('btnLogout')) {
  ...
  const { getUser } = await import('./auth.js?v=v2026-07-17T09192');
  if (btn.dataset.topbarAuthReady === '1') return;
