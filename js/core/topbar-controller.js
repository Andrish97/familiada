...
import { signOut } from './auth.js?v=v2026-07-15T21563';
import { isGuestUser } from './guest-mode.js?v=v2026-07-15T21563';
import { t, withLangParam } from '../../translation/translation.js?v=v2026-07-15T21563';
...
export async function autoInitTopbarAuthButton(btn = document.getElementById('btnLogout')) {
  ...
  const { getUser } = await import('./auth.js?v=v2026-07-15T21563');
  if (btn.dataset.topbarAuthReady === '1') return;
