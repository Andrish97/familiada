...
import { signOut } from './auth.js?v=v2026-04-08T17053';
import { isGuestUser } from './guest-mode.js?v=v2026-04-08T17053';
import { t, withLangParam } from '../../translation/translation.js?v=v2026-04-08T17053';
...
export async function autoInitTopbarAuthButton(btn = document.getElementById('btnLogout')) {
  ...
  const { getUser } = await import('./auth.js?v=v2026-04-08T17053');
  if (btn.dataset.topbarAuthReady === '1') return;
