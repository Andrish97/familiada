...
import { signOut } from './auth.js?v=v2026-07-17T09252';
import { isGuestUser } from './guest-mode.js?v=v2026-07-17T09252';
import { t, withLangParam } from '../../translation/translation.js?v=v2026-07-17T09252';
...
export async function autoInitTopbarAuthButton(btn = document.getElementById('btnLogout')) {
  ...
  const { getUser } = await import('./auth.js?v=v2026-07-17T09252');
  if (btn.dataset.topbarAuthReady === '1') return;
