...
import { signOut } from './auth.js?v=v2026-07-11T19195';
import { isGuestUser } from './guest-mode.js?v=v2026-07-11T19195';
import { t, withLangParam } from '../../translation/translation.js?v=v2026-07-11T19195';
...
export async function autoInitTopbarAuthButton(btn = document.getElementById('btnLogout')) {
  ...
  const { getUser } = await import('./auth.js?v=v2026-07-11T19195');
  if (btn.dataset.topbarAuthReady === '1') return;
