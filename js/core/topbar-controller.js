...
import { signOut } from './auth.js?v=v2026-06-22T20360';
import { isGuestUser } from './guest-mode.js?v=v2026-06-22T20360';
import { t, withLangParam } from '../../translation/translation.js?v=v2026-06-22T20360';
...
export async function autoInitTopbarAuthButton(btn = document.getElementById('btnLogout')) {
  ...
  const { getUser } = await import('./auth.js?v=v2026-06-22T20360');
  if (btn.dataset.topbarAuthReady === '1') return;
