...
import { signOut } from './auth.js?v=v2026-08-18T11321';
import { isGuestUser } from './guest-mode.js?v=v2026-08-18T11321';
import { t, withLangParam } from '../../translation/translation.js?v=v2026-08-18T11321';
...
export async function autoInitTopbarAuthButton(btn = document.getElementById('btnLogout')) {
  ...
  const { getUser } = await import('./auth.js?v=v2026-08-18T11321');
  if (btn.dataset.topbarAuthReady === '1') return;
