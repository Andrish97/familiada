...
import { signOut } from './auth.js?v=v2026-09-17T18574';
import { isGuestUser } from './guest-mode.js?v=v2026-09-17T18574';
import { t, withLangParam } from '../../translation/translation.js?v=v2026-09-17T18574';
...
export async function autoInitTopbarAuthButton(btn = document.getElementById('btnLogout')) {
  ...
  const { getUser } = await import('./auth.js?v=v2026-09-17T18574');
  if (btn.dataset.topbarAuthReady === '1') return;
