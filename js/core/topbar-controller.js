...
import { signOut } from './auth.js?v=v2026-07-16T22505';
import { isGuestUser } from './guest-mode.js?v=v2026-07-16T22505';
...
export async function autoInitTopbarAuthButton(btn = document.getElementById('btnLogout')) {
  ...
  const { getUser } = await import('./auth.js?v=v2026-07-16T22505');
  if (btn.dataset.topbarAuthReady === '1') return;
