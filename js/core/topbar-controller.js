...
import { signOut } from './auth.js?v=v2026-07-15T22012';
import { isGuestUser } from './guest-mode.js?v=v2026-07-15T22012';
import { t, withLangParam } from '../../translation/translation.js?v=v2026-07-15T22012';
...
export async function autoInitTopbarAuthButton(btn = document.getElementById('btnLogout')) {
  ...
  const { getUser } = await import('./auth.js?v=v2026-07-15T22012');
  if (btn.dataset.topbarAuthReady === '1') return;
