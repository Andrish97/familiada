...
import { signOut } from './auth.js?v=v2026-09-24T23225';
import { isGuestUser } from './guest-mode.js?v=v2026-09-24T23225';
...
export async function autoInitTopbarAuthButton(btn = document.getElementById('btnLogout')) {
  ...
  const { getUser } = await import('./auth.js?v=v2026-09-24T23225');
  if (btn.dataset.topbarAuthReady === '1') return;
