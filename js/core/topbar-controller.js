...
import { signOut } from './auth.js?v=v2026-07-13T07590';
import { isGuestUser } from './guest-mode.js?v=v2026-07-13T07590';
import { t, withLangParam } from '../../translation/translation.js?v=v2026-07-13T07590';
...
export async function autoInitTopbarAuthButton(btn = document.getElementById('btnLogout')) {
  ...
  const { getUser } = await import('./auth.js?v=v2026-07-13T07590');
  if (btn.dataset.topbarAuthReady === '1') return;
