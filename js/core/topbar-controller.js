...
import { signOut } from './auth.js?v=v2026-09-09T17421';
import { isGuestUser } from './guest-mode.js?v=v2026-09-09T17421';
import { t, withLangParam } from '../../translation/translation.js?v=v2026-09-09T17421';
...
export async function autoInitTopbarAuthButton(btn = document.getElementById('btnLogout')) {
  ...
  const { getUser } = await import('./auth.js?v=v2026-09-09T17421');
  if (btn.dataset.topbarAuthReady === '1') return;
