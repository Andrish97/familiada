...
import { signOut } from './auth.js?v=v2026-07-12T21411';
import { isGuestUser } from './guest-mode.js?v=v2026-07-12T21411';
import { t, withLangParam } from '../../translation/translation.js?v=v2026-07-12T21411';
...
export async function autoInitTopbarAuthButton(btn = document.getElementById('btnLogout')) {
  ...
  const { getUser } = await import('./auth.js?v=v2026-07-12T21411');
  if (btn.dataset.topbarAuthReady === '1') return;
