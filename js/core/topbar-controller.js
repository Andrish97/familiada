...
import { signOut } from './auth.js?v=v2026-04-05T02272';
import { isGuestUser } from './guest-mode.js?v=v2026-04-05T02272';
import { t, withLangParam } from '../../translation/translation.js?v=v2026-04-05T02272';
...
export async function autoInitTopbarAuthButton(btn = document.getElementById('btnLogout')) {
  ...
  const { getUser } = await import('./auth.js?v=v2026-04-05T02272');
  if (btn.dataset.topbarAuthReady === '1') return;
