...
import { signOut } from './auth.js?v=v2026-06-09T16413';
import { isGuestUser } from './guest-mode.js?v=v2026-06-09T16413';
import { t, withLangParam } from '../../translation/translation.js?v=v2026-06-09T16413';
...
export async function autoInitTopbarAuthButton(btn = document.getElementById('btnLogout')) {
  ...
  const { getUser } = await import('./auth.js?v=v2026-06-09T16413');
  if (btn.dataset.topbarAuthReady === '1') return;
