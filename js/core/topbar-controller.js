...
import { signOut } from './auth.js?v=v2026-04-15T01052';
import { isGuestUser } from './guest-mode.js?v=v2026-04-15T01052';
import { t, withLangParam } from '../../translation/translation.js?v=v2026-04-15T01052';
...
export async function autoInitTopbarAuthButton(btn = document.getElementById('btnLogout')) {
  ...
  const { getUser } = await import('./auth.js?v=v2026-04-15T01052');
  if (btn.dataset.topbarAuthReady === '1') return;
