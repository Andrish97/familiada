...
import { signOut } from './auth.js?v=v2026-08-22T07225';
import { isGuestUser } from './guest-mode.js?v=v2026-08-22T07225';
import { t, withLangParam } from '../../translation/translation.js?v=v2026-08-22T07225';
...
export async function autoInitTopbarAuthButton(btn = document.getElementById('btnLogout')) {
  ...
  const { getUser } = await import('./auth.js?v=v2026-08-22T07225');
  if (btn.dataset.topbarAuthReady === '1') return;
