...
import { signOut } from './auth.js?v=v2026-04-16T11325';
import { isGuestUser } from './guest-mode.js?v=v2026-04-16T11325';
import { t, withLangParam } from '../../translation/translation.js?v=v2026-04-16T11325';
...
export async function autoInitTopbarAuthButton(btn = document.getElementById('btnLogout')) {
  ...
  const { getUser } = await import('./auth.js?v=v2026-04-16T11325');
  if (btn.dataset.topbarAuthReady === '1') return;
