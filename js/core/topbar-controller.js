...
import { signOut } from './auth.js?v=v2026-09-19T23490';
import { isGuestUser } from './guest-mode.js?v=v2026-09-19T23490';
import { t, withLangParam } from '../../translation/translation.js?v=v2026-09-19T23490';
...
export async function autoInitTopbarAuthButton(btn = document.getElementById('btnLogout')) {
  ...
  const { getUser } = await import('./auth.js?v=v2026-09-19T23490');
  if (btn.dataset.topbarAuthReady === '1') return;
