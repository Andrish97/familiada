...
import { signOut } from './auth.js?v=v2026-05-12T15415';
import { isGuestUser } from './guest-mode.js?v=v2026-05-12T15415';
import { t, withLangParam } from '../../translation/translation.js?v=v2026-05-12T15415';
...
export async function autoInitTopbarAuthButton(btn = document.getElementById('btnLogout')) {
  ...
  const { getUser } = await import('./auth.js?v=v2026-05-12T15415');
  if (btn.dataset.topbarAuthReady === '1') return;
