...
import { signOut } from './auth.js?v=v2026-06-04T22162';
import { isGuestUser } from './guest-mode.js?v=v2026-06-04T22162';
import { t, withLangParam } from '../../translation/translation.js?v=v2026-06-04T22162';
...
export async function autoInitTopbarAuthButton(btn = document.getElementById('btnLogout')) {
  ...
  const { getUser } = await import('./auth.js?v=v2026-06-04T22162');
  if (btn.dataset.topbarAuthReady === '1') return;
