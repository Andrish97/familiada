...
import { signOut } from './auth.js?v=v2026-09-25T18594';
import { isGuestUser } from './guest-mode.js?v=v2026-09-25T18594';
...
export async function autoInitTopbarAuthButton(btn = document.getElementById('btnLogout')) {
  ...
  const { getUser } = await import('./auth.js?v=v2026-09-25T18594');
  if (btn.dataset.topbarAuthReady === '1') return;
