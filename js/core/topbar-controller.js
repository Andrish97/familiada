...
import { signOut } from './auth.js?v=v2026-04-08T03264';
import { isGuestUser } from './guest-mode.js?v=v2026-04-08T03264';
import { t, withLangParam } from '../../translation/translation.js?v=v2026-04-08T03264';
...
export async function autoInitTopbarAuthButton(btn = document.getElementById('btnLogout')) {
  ...
  const { getUser } = await import('./auth.js?v=v2026-04-08T03264');
  if (btn.dataset.topbarAuthReady === '1') return;
