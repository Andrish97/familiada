...
import { signOut } from './auth.js?v=v2026-09-26T14341';
import { isGuestUser } from './guest-mode.js?v=v2026-09-26T14341';
...
export async function autoInitTopbarAuthButton(btn = document.getElementById('btnLogout')) {
  ...
  const { getUser } = await import('./auth.js?v=v2026-09-26T14341');
  if (btn.dataset.topbarAuthReady === '1') return;
