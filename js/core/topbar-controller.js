...
import { signOut } from './auth.js?v=v2026-08-19T21174';
import { isGuestUser } from './guest-mode.js?v=v2026-08-19T21174';
import { t, withLangParam } from '../../translation/translation.js?v=v2026-08-19T21174';
...
export async function autoInitTopbarAuthButton(btn = document.getElementById('btnLogout')) {
  ...
  const { getUser } = await import('./auth.js?v=v2026-08-19T21174');
  if (btn.dataset.topbarAuthReady === '1') return;
