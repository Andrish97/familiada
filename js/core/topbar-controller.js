...
import { signOut } from './auth.js?v=v2026-04-20T12380';
import { isGuestUser } from './guest-mode.js?v=v2026-04-20T12380';
import { t, withLangParam } from '../../translation/translation.js?v=v2026-04-20T12380';
...
export async function autoInitTopbarAuthButton(btn = document.getElementById('btnLogout')) {
  ...
  const { getUser } = await import('./auth.js?v=v2026-04-20T12380');
  if (btn.dataset.topbarAuthReady === '1') return;
