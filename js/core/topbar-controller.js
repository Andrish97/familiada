...
import { signOut } from './auth.js?v=v2026-07-16T22552';
import { isGuestUser } from './guest-mode.js?v=v2026-07-16T22552';
...
export async function autoInitTopbarAuthButton(btn = document.getElementById('btnLogout')) {
  ...
  const { getUser } = await import('./auth.js?v=v2026-07-16T22552');
  if (btn.dataset.topbarAuthReady === '1') return;
