...
import { signOut } from './auth.js?v=v2026-05-13T19041';
import { isGuestUser } from './guest-mode.js?v=v2026-05-13T19041';
import { t, withLangParam } from '../../translation/translation.js?v=v2026-05-13T19041';
...
export async function autoInitTopbarAuthButton(btn = document.getElementById('btnLogout')) {
  ...
  const { getUser } = await import('./auth.js?v=v2026-05-13T19041');
  if (btn.dataset.topbarAuthReady === '1') return;
