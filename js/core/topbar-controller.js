...
import { signOut } from './auth.js?v=v2026-04-13T21455';
import { isGuestUser } from './guest-mode.js?v=v2026-04-13T21455';
import { t, withLangParam } from '../../translation/translation.js?v=v2026-04-13T21455';
...
export async function autoInitTopbarAuthButton(btn = document.getElementById('btnLogout')) {
  ...
  const { getUser } = await import('./auth.js?v=v2026-04-13T21455');
  if (btn.dataset.topbarAuthReady === '1') return;
