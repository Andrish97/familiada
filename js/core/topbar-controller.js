...
import { signOut } from './auth.js?v=v2026-07-12T22301';
import { isGuestUser } from './guest-mode.js?v=v2026-07-12T22301';
import { t, withLangParam } from '../../translation/translation.js?v=v2026-07-12T22301';
...
export async function autoInitTopbarAuthButton(btn = document.getElementById('btnLogout')) {
  ...
  const { getUser } = await import('./auth.js?v=v2026-07-12T22301');
  if (btn.dataset.topbarAuthReady === '1') return;
