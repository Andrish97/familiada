...
import { signOut } from './auth.js?v=v2026-05-31T21302';
import { isGuestUser } from './guest-mode.js?v=v2026-05-31T21302';
import { t, withLangParam } from '../../translation/translation.js?v=v2026-05-31T21302';
...
export async function autoInitTopbarAuthButton(btn = document.getElementById('btnLogout')) {
  ...
  const { getUser } = await import('./auth.js?v=v2026-05-31T21302');
  if (btn.dataset.topbarAuthReady === '1') return;
