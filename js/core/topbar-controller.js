...
import { signOut } from './auth.js?v=v2026-04-07T04472';
import { isGuestUser } from './guest-mode.js?v=v2026-04-07T04472';
import { t, withLangParam } from '../../translation/translation.js?v=v2026-04-07T04472';
...
export async function autoInitTopbarAuthButton(btn = document.getElementById('btnLogout')) {
  ...
  const { getUser } = await import('./auth.js?v=v2026-04-07T04472');
  if (btn.dataset.topbarAuthReady === '1') return;
