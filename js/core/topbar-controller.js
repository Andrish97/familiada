...
import { signOut } from './auth.js?v=v2026-04-14T23495';
import { isGuestUser } from './guest-mode.js?v=v2026-04-14T23495';
import { t, withLangParam } from '../../translation/translation.js?v=v2026-04-14T23495';
...
export async function autoInitTopbarAuthButton(btn = document.getElementById('btnLogout')) {
  ...
  const { getUser } = await import('./auth.js?v=v2026-04-14T23495');
  if (btn.dataset.topbarAuthReady === '1') return;
