...
import { signOut } from './auth.js?v=v2026-09-14T21091';
import { isGuestUser } from './guest-mode.js?v=v2026-09-14T21091';
import { t, withLangParam } from '../../translation/translation.js?v=v2026-09-14T21091';
...
export async function autoInitTopbarAuthButton(btn = document.getElementById('btnLogout')) {
  ...
  const { getUser } = await import('./auth.js?v=v2026-09-14T21091');
  if (btn.dataset.topbarAuthReady === '1') return;
