...
import { signOut } from './auth.js?v=v2026-09-26T05135';
import { isGuestUser } from './guest-mode.js?v=v2026-09-26T05135';
...
export async function autoInitTopbarAuthButton(btn = document.getElementById('btnLogout')) {
  ...
  const { getUser } = await import('./auth.js?v=v2026-09-26T05135');
  if (btn.dataset.topbarAuthReady === '1') return;
