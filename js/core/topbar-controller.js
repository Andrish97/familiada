...
import { signOut } from './auth.js?v=v2026-04-16T14391';
import { isGuestUser } from './guest-mode.js?v=v2026-04-16T14391';
import { t, withLangParam } from '../../translation/translation.js?v=v2026-04-16T14391';
...
export async function autoInitTopbarAuthButton(btn = document.getElementById('btnLogout')) {
  ...
  const { getUser } = await import('./auth.js?v=v2026-04-16T14391');
  if (btn.dataset.topbarAuthReady === '1') return;
