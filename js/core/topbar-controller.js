...
import { signOut } from './auth.js?v=v2026-09-25T19433';
import { isGuestUser } from './guest-mode.js?v=v2026-09-25T19433';
...
export async function autoInitTopbarAuthButton(btn = document.getElementById('btnLogout')) {
  ...
  const { getUser } = await import('./auth.js?v=v2026-09-25T19433');
  if (btn.dataset.topbarAuthReady === '1') return;
