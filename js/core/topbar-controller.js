...
import { signOut } from './auth.js?v=v2026-08-17T18112';
import { isGuestUser } from './guest-mode.js?v=v2026-08-17T18112';
import { t, withLangParam } from '../../translation/translation.js?v=v2026-08-17T18112';
...
export async function autoInitTopbarAuthButton(btn = document.getElementById('btnLogout')) {
  ...
  const { getUser } = await import('./auth.js?v=v2026-08-17T18112');
  if (btn.dataset.topbarAuthReady === '1') return;
