...
import { guardDesktopOnly } from "../../js/core/device-guard.js?v=v2026-09-25T18564";
import { guardResourceLock, guardResourceBusy } from "../../js/core/resource-lock.js?v=v2026-09-25T18564";
import { initI18n, getUiLang, t } from "../../translation/translation.js?v=v2026-09-25T18564";
import { requireAuth } from "../../js/core/auth.js?v=v2026-09-25T18564";
import { setTopbarAccount } from "../../js/core/topbar-controller.js?v=v2026-09-25T18564";
import { sb } from "../../js/core/supabase.js?v=v2026-09-25T18564";
import { loadQuestions, loadAnswers } from "../../js/core/game-validate.js?v=v2026-09-25T18564";
import { loadSfxManifest, initSfx, setCurrentGameId, unlockAudio, applySfxGameSettings, loadSfxFromCloud, playSfx, getSfxDuration } from "../../js/core/sfx.js?v=v2026-09-25T18564";
import { listGameSounds } from "../../js/core/sfx-cloud.js?v=v2026-09-25T18564";
...
import { DEFAULT_SETTINGS } from "../../shared/gameStateShape.js?v=v2026-09-25T18564";
import { rt } from "../../js/core/realtime.js?v=v2026-09-25T18564";
import { doorbellTopic } from "../../js/core/game-state-doorbell.js?v=v2026-09-25T18564";
...
import { createStore } from "./store.js?v=v2026-09-25T18564";
import { createEngine } from "./engine.js?v=v2026-09-25T18564";
import { createActionGate } from "./actionGate.js?v=v2026-09-25T18564";
import { createDevices } from "./devices.js?v=v2026-09-25T18564";
import { createPresence } from "./presence.js?v=v2026-09-25T18564";
import { createSoundReactor } from "./soundReactor.js?v=v2026-09-25T18564";
import { createUI } from "./ui.js?v=v2026-09-25T18564";
import { createShareDevice } from "./shareDevice.js?v=v2026-09-25T18564";
