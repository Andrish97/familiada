...
import { guardDesktopOnly } from "../../js/core/device-guard.js?v=v2026-09-26T19541";
import { guardResourceLock, guardResourceBusy } from "../../js/core/resource-lock.js?v=v2026-09-26T19541";
import { initI18n, getUiLang, t } from "../../translation/translation.js?v=v2026-09-26T19541";
import { requireAuth } from "../../js/core/auth.js?v=v2026-09-26T19541";
import { setTopbarAccount } from "../../js/core/topbar-controller.js?v=v2026-09-26T19541";
import { sb } from "../../js/core/supabase.js?v=v2026-09-26T19541";
import { loadQuestions, loadAnswers } from "../../js/core/game-validate.js?v=v2026-09-26T19541";
import { loadSfxManifest, initSfx, setCurrentGameId, unlockAudio, applySfxGameSettings, loadSfxFromCloud, playSfx, getSfxDuration } from "../../js/core/sfx.js?v=v2026-09-26T19541";
...
import { DEFAULT_SETTINGS } from "../../shared/gameStateShape.js?v=v2026-09-26T19541";
import { rt } from "../../js/core/realtime.js?v=v2026-09-26T19541";
import { doorbellTopic } from "../../js/core/game-state-doorbell.js?v=v2026-09-26T19541";
...
import { createEngine } from "./engine.js?v=v2026-09-26T19541";
import { createActionGate } from "./actionGate.js?v=v2026-09-26T19541";
import { createDevices } from "./devices.js?v=v2026-09-26T19541";
import { createPresence } from "./presence.js?v=v2026-09-26T19541";
import { createSoundReactor } from "./soundReactor.js?v=v2026-09-26T19541";
import { createUI } from "./ui.js?v=v2026-09-26T19541";
import { createShareDevice } from "./shareDevice.js?v=v2026-09-26T19541";
