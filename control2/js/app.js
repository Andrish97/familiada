...
import { guardDesktopOnly } from "../../js/core/device-guard.js?v=v2026-09-19T18005";
import { guardResourceLock, guardResourceBusy } from "../../js/core/resource-lock.js?v=v2026-09-19T18005";
import { initI18n, getUiLang, t } from "../../translation/translation.js?v=v2026-09-19T18005";
import { requireAuth } from "../../js/core/auth.js?v=v2026-09-19T18005";
import { setTopbarAccount } from "../../js/core/topbar-controller.js?v=v2026-09-19T18005";
import { sb } from "../../js/core/supabase.js?v=v2026-09-19T18005";
import { loadQuestions, loadAnswers } from "../../js/core/game-validate.js?v=v2026-09-19T18005";
import { loadSfxManifest, initSfx, setCurrentGameId, unlockAudio, applySfxGameSettings, loadSfxFromCloud, playSfx, getSfxDuration } from "../../js/core/sfx.js?v=v2026-09-19T18005";
import { listGameSounds } from "../../js/core/sfx-cloud.js?v=v2026-09-19T18005";
...
import { DEFAULT_SETTINGS } from "../../shared/gameStateShape.js?v=v2026-09-19T18005";
import { rt } from "../../js/core/realtime.js?v=v2026-09-19T18005";
import { doorbellTopic } from "../../js/core/game-state-doorbell.js?v=v2026-09-19T18005";
...
import { createStore } from "./store.js?v=v2026-09-19T18005";
import { createEngine } from "./engine.js?v=v2026-09-19T18005";
import { createActionGate } from "./actionGate.js?v=v2026-09-19T18005";
import { createDevices } from "./devices.js?v=v2026-09-19T18005";
import { createPresence } from "./presence.js?v=v2026-09-19T18005";
import { createSoundReactor } from "./soundReactor.js?v=v2026-09-19T18005";
import { createUI } from "./ui.js?v=v2026-09-19T18005";
import { createShareDevice } from "./shareDevice.js?v=v2026-09-19T18005";
...
async function main() {
  ...
  function requestGsModalClose() {
    console.warn("[e2e-diag] requestGsModalClose() wysyła gs:requestClose");
  ...
  gsOverlayEl?.addEventListener("click", (ev) => {
    console.warn("[e2e-diag] klik na gsOverlayEl, ev.target===gsOverlayEl:", ev.target === gsOverlayEl, "ev.target:", ev.target?.id || ev.target?.tagName);
    if (ev.target === gsOverlayEl) requestGsModalClose();
  });
  window.addEventListener("message", (ev) => {
    console.warn("[e2e-diag] app.js message listener, data:", JSON.stringify(ev.data), "source match:", ev.source === gsFrameEl?.contentWindow);
