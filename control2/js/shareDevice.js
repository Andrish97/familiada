...
// Zamiast tego: control2/js/ui.js emituje "devices.shareOpen" przy kliknięciu
// (zwykły wzorzec tego pliku), a ten moduł wystawia open(kind) do wywołania
// z control2/js/app.js's handle(). Znaczki (badge) też nie są aktualizowane
...
async function sendShareEmail({ to, ownerLabel, deviceType, gameId, gameName, shareKey }) {
  ...
  const page = deviceType === "display" ? "display2" : `${deviceType}2`;
