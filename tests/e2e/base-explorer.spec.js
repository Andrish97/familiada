...
/* =====================================================================
   5) Mobile "sheet" modal (js/core/modal-sheet.js) -- na telefonie modale
   tagów/eksportu/pytania zastępują treść strony zamiast być wyśrodkowanym
   okienkiem. base-explorer.html NIE ma stopki (.footer) -- w odróżnieniu
   od innych stron w tym repo, więc tu nie sprawdzamy punktów
   footer/btn-contact-footer z planu, tylko te, które faktycznie dotyczą
   tej strony.
===================================================================== */
...
test.describe("base-explorer: mobile sheet modal (tagi/eksport/pytanie)", () => {
  ...
  test("modal tagów na telefonie zastępuje treść strony (sheet)", async ({ page, context }) => {
    ...
    try {
      ...
      // reszta layoutu (drzewo/lista) jest ukryta
