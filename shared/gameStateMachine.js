...
export const STEPS = {
  ...
  r_play: {
    ...
    dataShape: "controlTeam, bankPts, xA, xB, revealed[], steal={active,used,team,won}, allowPass, passUsed, duel={...,cycleFirstAnswered,cycleSecondAnswered,cycleFirstPts,cycleSecondPts,cycleFirstIsX,cycleSecondIsX}",
    gatedBy: [],
    ...
    next: ["r_play", "r_roundStart", "f_start", "r_gameEnd"],
  },
  r_gameEnd: {
    card: "rounds",
