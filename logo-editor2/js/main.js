// familiada/logo-editor2/js/main.js
// Glowna logika strony + lista kafelkow + routing do edytorow.

import { addRenameGesture } from "../../js/core/rename-gesture.js?v=v2026-09-26T05304";
import { loadFont5x7, buildLogoPreviewCanvas } from "../../js/core/logo-preview.js?v=v2026-09-26T05304";

import { sb } from "../../js/core/supabase.js?v=v2026-09-26T05304";
import { requireAuth } from "../../js/core/auth.js?v=v2026-09-26T05304";
import { isGuestUser } from "../../js/core/guest-mode.js?v=v2026-09-26T05304";
import { alertModal, confirmModal } from "../../js/core/modal.js?v=v2026-09-26T05304";
...
import { guardResourceLock, isResourceBusy, findBusyContext } from "../../js/core/resource-lock.js?v=v2026-09-26T05304";
...
const DEFAULT_LOGO_URL = "display/logo_familiada.json?v=v2026-09-26T05304";
...
async function boot(){
  ...
  import('../../js/core/updater.js?v=v2026-09-26T05304').then(m => m.initUpdater()).catch(() => {});
